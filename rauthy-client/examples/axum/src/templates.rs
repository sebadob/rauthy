...
<body>
    ...
    <script>
        ...
        function logout() {
            ...
            let uri = document.querySelector('#logoutUri').content.textContent;
            let id_token = localStorage.getItem('id_token');
            window.location.href = `${uri}?id_token_hint=${id_token}&post_logout_redirect_uri=${window.location.origin}`;
        }
    </script>
</body>
</html>
