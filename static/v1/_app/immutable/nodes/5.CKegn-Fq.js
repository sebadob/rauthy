import { t as k, a as d, e as we, d as Re } from "../chunks/YHhP1LbZ.js";
import { p as Te, c as r, s as v, j as e, a9 as ie, r as t, t as D, a as Ce, a8 as he, k as M, l as o, f as xe, a6 as Ze, aa as Se, a7 as Qt } from "../chunks/Ck6jKiur.js";
import { s as l, d as Xt, h as Zt } from "../chunks/tDAaDMC_.js";
import { i as w } from "../chunks/7JDmqCCW.js";
import { p as m } from "../chunks/ho0YXExL.js";
import { a as lt, b as S, c as q, s as ze, r as er } from "../chunks/BTaFr7HN.js";
import { b as tr } from "../chunks/DOEB3Ovi.js";
import { p as $e } from "../chunks/DZP54pO_.js";
import { l as Qe, Q as ot, J as rr, P as ar, K as sr, z as vr, S as wt, D as or, r as nr } from "../chunks/B21bTIl7.js";
import { e as Et } from "../chunks/Cj5zIR7o.js";
import { h as Tt } from "../chunks/DZNCtpeX.js";
import { C as Xe } from "../chunks/CY4mVlEI.js";
import { B as ye, t as Le, f as Ne, s as ir } from "../chunks/Bd2Rvcxs.js";
import { M as lr } from "../chunks/DnVb7Nyf.js";
import { u as Me } from "../chunks/mN05BXqA.js";
import { c as Ct, b as nt, d as dt, f as Ve } from "../chunks/BO1A6s0c.js";
import { B as dr } from "../chunks/QNbYgHEk.js";
import { U as ur, a as cr, D as Dt } from "../chunks/Q8Ah1TjY.js";
import { I as De } from "../chunks/D75ao6x5.js";
import { F as fr } from "../chunks/iKqYlEgo.js";
import { b as it, k as _r, l as bt, m as pr } from "../chunks/BRCxk8by.js";
import { I as ut } from "../chunks/CWz_piBP.js";
import { I as mr } from "../chunks/xKzkh2rf.js";
import { u as ct } from "../chunks/lKncIEmp.js";
import { w as gr } from "../chunks/h4_EZIry.js";
import { W as Mt } from "../chunks/CvwfYfQa.js";
import { P as hr } from "../chunks/C8NGz9gp.js";
import { I as st } from "../chunks/C1PH3bBF.js";
import { s as wr } from "../chunks/9ksWc3Vn.js";
import { c as br } from "../chunks/0HgaTnX3.js";
import { A as yr } from "../chunks/C42IzXc-.js";
import { I as xr } from "../chunks/G3H5k1qO.js";
import { T as kr } from "../chunks/PiKtpHUv.js";
import { u as Pr } from "../chunks/4NKlJeDw.js";
import { T as yt } from "../chunks/Doh1wgOS.js";
import { I as Ir } from "../chunks/mFBwQ9am.js";
import { M as $r } from "../chunks/rkCvXuuX.js";
import { C as Er } from "../chunks/DIUoHniG.js";
import { T as Tr } from "../chunks/B31o65yn.js";
import { L as Cr } from "../chunks/DsAM5_DI.js";
...
function vt(oe, f) {
  Te(f, true);
  let s = $e(f, "user", 15), a = Me(), P = M(false), n = M(false), T = ie(() => {
    var _a2;
    return (_a2 = s().account_type) == null ? void 0 : _a2.startsWith("federated");
  }), g = ie(() => {
    var _a2;
    return e(T) ? `${s().account_type}: ${((_a2 = f.authProvider) == null ? void 0 : _a2.name) || ""}` : s().account_type;
  }), i = ie(() => f.viewModePhone ? "rowPhone" : "row"), b = ie(() => f.viewModePhone ? "labelPhone" : "label"), I = ie(() => {
  ...
  }, [() => s().password_expires && Qe(s().password_expires) || a.common.never, () => Qe(s().created_at)]), d(oe, Y), Ce();
}
...
function xt(oe, f) {
  ...
  fr(b, { get action() {
    ...
    De(ae, { typ: "email", name: "email", get label() {
    ...
    var z = v(ae, 2);
    De(z, { name: "given_name", autocomplete: "given-name", get label() {
    ...
    var Z = v(z, 2);
    De(Z, { name: "family_name", autocomplete: "family-name", get label() {
    ...
    var B = v(Q, 2), K = r(B);
    De(K, { name: "street", autocomplete: "street-address", get label() {
    ...
    var ee = v(K, 2);
    De(ee, { typ: "number", name: "zip", autocomplete: "postal-code", get label() {
    ...
    var re = v(ee, 2);
    De(re, { name: "city", autocomplete: "address-level2", get label() {
    ...
    var V = v(re, 2);
    De(V, { name: "country", autocomplete: "country", get label() {
    ...
    var C = v(V, 2);
    De(C, { name: "phone", autocomplete: "tel", get label() {
    ...
    d(u, J);
  }, $$slots: { default: true } }), t(i), d(oe, i), Ce();
}
...
function kt(oe, f) {
  ...
  }), T = M(void 0), g = M(false), i = M(""), b = M(false), I = M(f.user.account_type === "password"), u = M(void 0), $ = M(""), J = M(false), Y = M(m([]));
  Ze(() => {
    ae();
  }), Se(() => {
    e(Y).length > 0 && f.user.account_type === "passkey" && o(I, e(Y).length > 1);
  }), Se(() => {
    var _a2;
  ...
  async function Z(C) {
    var _a2;
    let _ = await Ct(`/auth/v1/users/${f.user.id}/webauthn/delete/${C}`);
    _.status === 200 ? await ae() : o(i, m(((_a2 = _.error) == null ? void 0 : _a2.message) || "Error"));
  }
  function se(C) {
  ...
  var K = Gr(), ee = r(K);
  {
    var re = (C) => {
      ...
      var h = v(X, 2);
      {
        var x = (A) => {
          var y = Kr(), E = xe(y);
          De(E, { autocomplete: "off", get label() {
...
function Qr(oe, f) {
  Te(f, true);
  let s = $e(f, "passwords", 15), a = $e(f, "hideCurrentPassword", 3, false), P = $e(f, "isValid", 15), n = Me();
  P($);
  ...
  var Y = Re(), Q = xe(Y);
  {
    var ae = (z) => {
      ...
      var _ = v(V, 2), R = r(_, true);
      t(_), t(Z), D(() => l(R, e(g))), d(z, Z);
    };
    w(Q, (z) => {
      e(i) && z(ae);
    });
  }
  return d(oe, Y), Ce({ isPwdValid: $ });
}
...
function Pt(oe, f) {
  Te(f, true);
  let s = $e(f, "user", 15), a = Me(), P = ie(() => f.viewModePhone ? "calc(100vw - 1.5rem)" : "300px"), n = M(m(s().account_type)), T = M(m([])), g = M(void 0), i = M(false), b = M(false), I = M(""), u = M(false), $ = M(void 0), J = M(m({ current: "", new: "", newConfirm: "" })), Y = ie(() => e(T).filter((h) => h.user_verified).length > 0);
  Ze(() => {
    Q();
  });
  async function Q() {
  ...
  var _ = v(V, 2);
  {
    var R = (h) => {
      ...
      t(x), D(() => {
        var _a2;
        l(L, a.account.federatedConvertPassword1), l(F, ((_a2 = f.authProvider) == null ? void 0 : _a2.name) || "UNKNOWN"), l(le, a.account.federatedConvertPassword2);
      }), d(h, x);
    };
    w(_, (h) => {
      e(n) === "federated" && h(R);
...
function It(oe, f) {
  Te(f, true);
  let s = $e(f, "checked", 15, false), a = $e(f, "ariaLabel", 3, ""), P = $e(f, "name", 3, "");
  function n() {
    s(!s());
  }
  var T = na(), g = r(T);
  ...
  er(u), u.__click = n, u.__keydown = [oa, n], he(2), t(I), t(T), D(() => {
    i = lt(g, "", i, { width: f.labelWidth }), ze(u, "name", P()), u.disabled = f.disabled, ze(u, "aria-checked", s()), ze(u, "aria-label", a());
  }), br(u, s), d(oe, T), Ce();
}
Xt(["click", "keydown"]);
...
function $t(oe, f) {
  Te(f, true);
  let s = $e(f, "webIdData", 15), a = Me();
  const P = "14rem";
  let n = M(""), T = M(false), g = M(!!s().custom_triples), i = ot(s().user_id);
  async function b() {
    o(n, "");
    let _ = await dt(`/auth/v1/users/${s().user_id}/webid/data`, s());
    _.error ? o(n, m(_.error.message)) : (o(T, true), setTimeout(() => {
      o(T, false);
    }, 3e3));
  }
  ...
  t(u);
  var J = v(u, 2), Y = r(J);
  yr(Y, { href: i, target: "_blank", children: (_, R) => {
    var p = Re(), X = xe(p);
    Tt(X, () => i.replace("/auth/", "/auth/<wbr/>")), d(_, p);
  ...
  It(Z, { get ariaLabel() {
    ...
    he();
    var p = we();
    D(() => l(p, a.account.webIdExpertMode)), d(_, p);
  ...
  var se = v(z, 2);
  {
    var B = (_) => {
      ...
      } }), t(R), D(() => l(X, a.account.webIdDescData)), Le(3, R, () => ir), d(_, R);
    };
    w(se, (_) => {
      e(g) && _(B);
    });
  ...
  var K = v(se, 2), ee = r(K);
  ye(ee, { onclick: b, children: (_, R) => {
    he();
    var p = we();
    D(() => l(p, a.common.save)), d(_, p);
  }, $$slots: { default: true } });
  var re = v(ee, 2);
  {
    var V = (_) => {
      var R = la(), p = r(R);
      ut(p, {}), t(R), Le(3, R, () => Ne), d(_, R);
    }, C = (_, R) => {
      {
        var p = (X) => {
  ...
  t(K), t(I), D(() => l($, a.account.webIdDesc)), d(oe, I), Ce();
}
function ca(oe, f) {
  Te(f, true);
...
function wa(oe, f) {
  ...
  let a = $e(f, "user", 15), P = $e(f, "webIdData", 15), n = Me(), T = M(void 0), g = M(m([])), i = ie(() => {
    var _a2;
  ...
  t(ae), tr("innerWidth", (B) => o(T, m(B))), d(oe, Y), Ce();
}
var ba = k("<!> <!> <!>", 1);
function ns(oe, f) {
  Te(f, true);
