...
import { T as Ie } from "../chunks/DX6irJfo.js";
import { L as Ce } from "../chunks/KzU4-o98.js";
import { p as Pe } from "../chunks/u-vgjdTr.js";
import { f as ze, b as Ve } from "../chunks/CRjU5SuJ.js";
import { R as qe } from "../chunks/BjNKHfO0.js";
import { A as We } from "../chunks/8APYSIIx.js";
...
import { V as Re, k as pe, i as Ze, D as $e } from "../chunks/Brp0G0eV.js";
import { T as De } from "../chunks/BmpEzKyJ.js";
import { u as Ue } from "../chunks/CO1TlAUy.js";
import { e as Ge } from "../chunks/BpWRzPRQ.js";
import { E as Ke } from "../chunks/DYeL-YEn.js";
import { u as Fe } from "../chunks/CgEHB2u3.js";
import { O as Je } from "../chunks/ahjiAH8y.js";
...
function Ot(c, r) {
  ...
  var k = Nt(), u = h(k), x = h(u), M = h(x), L = h(M), X = h(L), D = h(X);
  de(D, { ariaControls: "mainNav", invisible: true, onclick: R, children: (C, S) => {
    var F = jt(), re = h(F);
    ot(re, {}), d(F), n(C, F);
  ...
  var U = g(X, 2);
  {
    var te = (C) => {
      var S = Tt(), F = h(S);
      de(F, { invisible: true, onclick: j, children: (re, ie) => {
        var J = St(), V = h(J);
        it(V, {}), d(J), n(re, J);
  ...
  var G = g(M, 2);
  {
    var w = (C) => {
      ...
      } }), d(J), p(() => ve(J, "margin-top", t(e) ? ".5rem" : "1.5rem")), n(C, S);
    };
    ee(G, (C) => {
      t(y) || C(w);
    });
      ...
      var S = Wt();
      {
        const J = (V) => {
          ...
          de(q, { invisible: true, onclick: () => Re(), children: (W, oe) => {
            De(W, { text: "Logout", children: (ne, le) => {
              Lt(ne, {});
            }, $$slots: { default: true } });
...
function Dt(c, r) {
  ...
  var u = $t();
  let x;
  var M = h(u), L = h(M), X = h(L), D = g(h(X), 2);
  Je(D, { get ariaLabel() {
  ...
  var U = g(X, 2);
  de(U, { level: 3, onclick: j, children: (w, K) => {
    E();
    var ae = T("Test");
    n(w, ae);
...
var Ut = b('<div class="noAdmin svelte-drznxl"><div><div class="text svelte-drznxl"><!></div> <!></div></div>'), Gt = b('<div class="noAdmin svelte-drznxl"><div><div class="text svelte-drznxl"><!></div> <!></div></div>'), Kt = b('<div class="events"><!></div>'), Ft = b('<div class="content svelte-drznxl"><!></div> <!>', 1), Jt = b("<!> <!>", 1);
function Mr(c, r) {
  he(r, true), Oe();
  let a = we(), l = Ue("admin"), i = H(void 0), e = H(false), y = H(false), _ = H(false);
  se(() => {
    var _a;
    let u = l.get();
  ...
  {
    var j = (u) => {
      var x = Ut(), M = h(x), L = h(M), X = h(L);
      be(X, () => a.error.noAdmin), d(L);
      var D = g(L, 2);
      de(D, { onclick: () => window.location.href = "/auth/v1/account", children: (U, te) => {
        E();
        var G = T();
        p(() => P(G, a.common.account)), n(U, G);
      }, $$slots: { default: true } }), d(M), d(x), n(u, x);
    }, k = (u) => {
      var x = ce(), M = Y(x);
      {
        var L = (D) => {
          var U = Gt(), te = h(U), G = h(te), w = h(G);
          ...
          }, $$slots: { default: true } }), d(te), d(U), n(D, U);
        }, X = (D) => {
          var U = ce(), te = Y(U);
          {
            var G = (w) => {
