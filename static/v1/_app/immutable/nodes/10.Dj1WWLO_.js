...
import { B as tr } from "../chunks/dWvWuq1E.js";
import { C as rr } from "../chunks/BnPoFdx3.js";
import { N as ar } from "../chunks/D-L0o8jR.js";
import { N as lr } from "../chunks/CUuTpoTi.js";
import { O as ir } from "../chunks/wXCWlxMM.js";
import { b as Ve, d as We, c as He, f as St } from "../chunks/DYtiVhoA.js";
import { u as nr } from "../chunks/BpfzNsA6.js";
import { h as we } from "../chunks/i8Xqpu09.js";
import { I as fe } from "../chunks/CeeD0cV_.js";
import { n as sr, g as pt, a as Be, o as or, p as dr, q as Et } from "../chunks/BRCxk8by.js";
import { F as Ge } from "../chunks/Gcs0S4Fz.js";
...
import { g as ke } from "../chunks/B8wC3kJv.js";
...
import { S as At } from "../chunks/Bbu1Qkv4.js";
import { O as Tt } from "../chunks/BPVdf4Rb.js";
import { I as vr } from "../chunks/D6E4lNPv.js";
import { k as ur } from "../chunks/CaD2yKt4.js";
import { T as fr } from "../chunks/C6vpM94V.js";
import { R as hr } from "../chunks/2DYY54Zs.js";
import { I as _r } from "../chunks/49lB1QJe.js";
function gr(M, e, r, o) {
  var _a;
...
function be(M, e) {
  re(e, true);
  let r = Z(e, "ref", 15), o = Z(e, "typ", 3, "text"), d = Z(e, "id", 19, ke), f = Z(e, "values", 31, () => i([])), b = Z(e, "label", 3, ""), h = Z(e, "placeholder", 3, ""), w = Z(e, "disabled", 3, false), y = Z(e, "required", 3, false), _ = Z(e, "isError", 15, false), k = Z(e, "width", 3, "inherit"), I = Z(e, "maxHeightList", 3, "inherit"), m = xe();
  const C = ke();
  ...
  function A() {
    ...
    return N ? (_(!N.valid), N.valid) : (_(false), true);
  }
  var D = Cr();
  D.__click = [br, r];
  var l = v(D), g = v(l);
  ...
  c(K), c(D), O(() => {
    W(D, "width", k()), W(l, "max-height", I()), F(S, "type", o()), F(S, "id", d()), F(S, "name", e.name), F(S, "list", t(L)), F(S, "title", e.errMsg), F(S, "aria-label", b() || h()), F(S, "placeholder", h()), F(S, "aria-placeholder", h()), S.disabled = w(), F(S, "aria-disabled", w()), S.required = y() && f().length < 1, F(S, "aria-required", y() && f().length < 1), F(S, "maxlength", e.maxLength || void 0), F(S, "min", e.min || void 0), F(S, "max", e.max || void 0), F(S, "pattern", e.pattern), F(K, "for", d()), F(K, "data-required", y()), R(G, `${b() ?? ""} `);
...
function Ar(M, e) {
  re(e, true);
  let r = xe(), o = ge(), d = x(void 0), f = x(""), b = x(""), h = x(""), w = x(true), y = x(i([])), _ = x(i([]));
  _e(() => {
  ...
  async function k(C, P) {
    var _a;
    if (e.clients.find((U) => U.id === t(b))) {
      n(f, i(o.common.nameExistsAlready));
      return;
    }
    n(f, "");
    let L = { id: t(b), name: t(h) || void 0, confidential: t(w), redirect_uris: t(y), post_logout_redirect_uris: t(_).length > 0 ? t(_) : void 0 }, B = await Ve(C.action, L);
    B.body ? e.onSave(B.body.id) : n(f, i(((_a = B.error) == null ? void 0 : _a.message) || "Error"));
  }
  var I = Sr(), m = v(I);
  Ge(m, { action: "/auth/v1/clients", onSubmit: k, children: (C, P) => {
    var L = Lr(), B = te(L);
    ...
    var D = a(Q, 2);
    be(D, { typ: "url", label: "Redirect URIs", get errMsg() {
    ...
    var l = a(D, 2);
    be(l, { typ: "url", label: "Post Logout Redirect URIs", get errMsg() {
      return o.validation.uri;
    }, get values() {
      return t(_);
    }, set values(p) {
...
function Er(M, e) {
  ...
  async function S(G, le) {
    ...
    N.error ? n(f, i(N.error.message)) : (n(b, true), e.onSave(), setTimeout(() => {
      n(b, false);
    }, 2e3));
  }
  var p = pr(), H = v(p);
  ...
  Ge(H, { get action() {
    ...
    c(Ie);
    var ct = a(Ie, 2);
    be(ct, { typ: "url", label: "Allowed Origins", get errMsg() {
    ...
    var vt = a(Re, 2);
    be(vt, { typ: "url", label: "Redirect URIs", get errMsg() {
      return o.validation.uri;
    }, get required() {
      return L.authorizationCode;
    ...
    var ut = a(vt, 2);
    be(ut, { typ: "url", label: "Post Logout Redirect URIs", get errMsg() {
      return o.validation.uri;
    }, pattern: Be, get values() {
      return t(P);
    }, set values(s) {
...
function Or(M, e) {
  ...
  O(() => R(w, o.clients.delete1)), u(M, b), ae();
}
...
function qe(M, e) {
  re(e, true);
  let r = Z(e, "value", 15), o = Z(e, "label", 3, ""), d = Z(e, "disabled", 3, false), f = Z(e, "step", 3, 1), b = Z(e, "widthRange", 3, "15rem");
  const h = ke();
  let w = he(() => {
  ...
  var y = qr(), _ = v(y), k = v(_);
  Je(k), F(k, "id", h);
  var I = a(k, 2), m = v(I, true);
  c(I), c(_);
  var C = a(_, 2), P = v(C);
  F(P, "for", h);
  var L = v(P, true);
  c(P), c(C), c(y), O(() => {
    F(k, "name", e.name), F(k, "title", o()), F(k, "aria-label", o()), k.disabled = d(), F(k, "aria-disabled", d()), F(k, "min", e.min), F(k, "max", e.max), F(k, "step", f()), W(k, "width", b()), W(k, "--bg-slider", t(w)), R(m, r()), R(L, o());
  }), Qe(k, r), u(M, y), ae();
}
...
function me(M, e) {
  ...
  F(m, "id", f);
  var C = v(m);
  qe(C, { label: "Hue", min: 0, max: 359, widthRange: b, bgMode: "hue", get hue() {
    return r();
  }, get sat() {
    return o();
  }, get lum() {
  ...
  var P = a(C, 2);
  qe(P, { label: "Sat", min: 0, max: 100, widthRange: b, bgMode: "sat", get hue() {
    return r();
  }, get sat() {
    return o();
  }, get lum() {
  ...
  var L = a(P, 2);
  qe(L, { label: "Lum", min: 0, max: 100, widthRange: b, bgMode: "lum", get hue() {
    return r();
  }, get sat() {
    return o();
  }, get lum() {
...
function je(M, e) {
  ...
  h.__click = [Fr, d];
  var w = a(v(h), 2);
  Je(w), Mt(w, (y) => n(d, y), () => t(d)), c(h), c(f), O(() => W(f, "--color", r())), Qe(w, r), u(M, f), ae();
}
Ke(["click"]);
...
function It(M, e) {
  ...
  var d = Hr(), f = v(d), b = v(f, true);
  c(f);
  var h = a(f, 2), w = v(h), y = v(w);
  ...
  } }), c(B), c(d), O(() => R(b, o.clients.branding.descHsl)), u(M, d), ae();
}
...
function Rt(M, e) {
  ...
  var d = Wr(), f = v(d), b = v(f), h = v(b), w = v(h);
  {
    var y = (l) => {
  ...
  c(h);
  var k = a(h, 8);
  fe(k, { label: "Preview", placeholder: "Preview", width: "12.5rem" });
  var I = a(k, 2), m = v(I), C = v(m);
  ...
  var D = a(A, 4);
  fr(D, {}), c(b), c(f), c(d), O((l, g, E, S, p, H, K) => {
...
Ke(["click"]);
var Gr = q('<div><h2>Preview</h2> <!> <div class="preview svelte-1nlq99j"><!></div></div>');
function Jr(M, e) {
  re(e, true);
...
function Zr(M, e) {
  re(e, true);
  const r = "13rem";
  let o = xe(), d = ge(), f = x(false), b = x(""), h = x(void 0), w = x(i(ke())), y = he(() => `/auth/v1/clients/${e.client.id}/logo?${t(w)}`), _ = he(() => `/auth/v1/theme/${e.client.id}`);
  _e(() => {
    k();
  });
  async function k() {
    var _a;
    let P = await Ve(t(_));
    P.body ? (P.body.client_id === "rauthy" && console.log("using Rauthy default scheme"), n(h, i(P.body))) : n(b, i(((_a = P.error) == null ? void 0 : _a.message) || "Error"));
  }
  async function I(P, L) {
    ...
    let U = await We(t(_), B);
    U.error ? n(b, i(U.error.message)) : (n(f, true), setTimeout(() => {
      n(f, false);
    }, 2e3));
  }
  async function m() {
    let P = await He(t(_));
    P.error ? n(b, i(P.error.message)) : (await He(`/auth/v1/clients/${e.client.id}/logo`), await k(), n(f, true), setTimeout(() => {
      n(f, false);
    }, 2e3));
  }
  async function C() {
...
function ea(M, e) {
  ...
  let f = x(i(d[0])), b = x(void 0);
  _e(() => {
    e.client.id && requestAnimationFrame(() => {
      var _a;
      (_a = t(b)) == null ? void 0 : _a();
    });
  });
  var h = $r(), w = te(h), y = v(w);
...
function na(M, e) {
  re(e, true);
  let r = x(void 0), o = x(""), d = x(i([])), f = x(i([])), b = x(void 0), h = nr("cid"), w = x(i([]));
  const y = ["ID"];
  let _ = x(i(y[0])), k = x("");
  const I = ["ID"];
  Yt(() => {
    ...
    n(b, i(t(d).find((A) => A.id === h.get())));
  }), _e(() => {
    let A = t(k).toLowerCase();
    A ? t(_) === y[0] && n(f, i(t(d).filter((D) => D.id.toLowerCase().includes(A)))) : n(f, i(t(d)));
  });
  async function m() {
    var _a;
  ...
  async function C() {
    ...
    A.body ? n(w, i(A.body.map((D) => D.name))) : n(o, i(((_a = A.error) == null ? void 0 : _a.message) || "Error"));
  }
  function P(A, D) {
    let l = D === "up";
