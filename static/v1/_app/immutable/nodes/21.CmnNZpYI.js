import { n as ge, a as u, t as O, e as U, d as se } from "../chunks/DKC5GJ29.js";
import { t as _, p as ae, k as w, c as y, r as C, a as le, s as p, j as s, a9 as xe, f as K, a8 as j, l as a, a6 as we, aa as Pe } from "../chunks/BveBAmlr.js";
import { s as P } from "../chunks/CYCba2oX.js";
import { i as W } from "../chunks/D-uYoVwt.js";
import { e as re } from "../chunks/BLE4FKaJ.js";
import { p as d } from "../chunks/VbPNpVtZ.js";
import { l as X, r as $e } from "../chunks/B21bTIl7.js";
import { B as N } from "../chunks/DlLEcmNg.js";
import { P as oe } from "../chunks/C1vENVPM.js";
import { s as Z, b as Se, a as ye } from "../chunks/Dql74IOz.js";
import { C as Ce } from "../chunks/5J717Kcr.js";
import { E as Ie } from "../chunks/VvDlSTic.js";
import { T as J } from "../chunks/B100j8aI.js";
import { u as De } from "../chunks/8R5My_LO.js";
import { u as ne } from "../chunks/DtT3Jahq.js";
import { L as M } from "../chunks/FI26onRO.js";
import { p as Y } from "../chunks/Db0ChEdV.js";
import { c as de, f as be } from "../chunks/BO1A6s0c.js";
import { C as Te } from "../chunks/CqiL-eHy.js";
import { O as Le } from "../chunks/CPgfHyhH.js";
import { u as ke } from "../chunks/CPBhBTQd.js";
import { P as Oe, f as Fe, a as Ae } from "../chunks/CS5oucLY.js";
...
function ze(B, l) {
  let $ = Y(l, "opacity", 3, 0.9), x = Y(l, "width", 3, "1.5rem"), n = Y(l, "color", 3, "hsl(var(--error))");
  var c = Ee();
  Z(c, "stroke-width", 2), _(() => {
    Z(c, "stroke", n()), Z(c, "width", x()), Z(c, "opacity", $());
  }), u(B, c);
}
...
function ie(B, l) {
  ...
  Ie(E, { summary: (S) => {
    ...
    var L = p(q, 2);
    N(L, { invisible: true, onclick: c, children: (g, z) => {
      const o = xe(() => `IP - ${s(n)}`);
      J(g, { get text() {
        return s(o);
      }, children: (r, t) => {
    ...
    }, $$slots: { default: true } }), C(h), C(m), u(S, m);
  }, details: (S) => {
    var m = Ge(), T = K(m);
    ...
    N(o, { level: -1, onclick: F, children: (r, t) => {
      j();
      var e = U();
      _(() => P(e, $.common.delete)), u(r, e);
    }, $$slots: { default: true } }), u(S, m);
  }, $$slots: { summary: true, details: true } }), C(A), _((I) => H = Se(A, 1, "container svelte-79owtg", null, H, I), [() => ({ expired: l.session.exp < l.now })]), u(B, A), le();
}
var Re = O('<div class="err"> </div>'), Ve = O('<div class="top svelte-1sljqh8"><!> <div class="btn svelte-1sljqh8"><!></div></div> <!> <div id="sessions"><!></div> <!>', 1);
function We(B, l) {
  ae(l, true);
  let $ = ne(), x = w(""), n = w(d([])), c = w(d([])), F = w(d([])), A = w(Date.now() / 1e3), H = w(false), E = w(void 0), I = w(d(Oe)), V = w(false), S = ["User ID", "Session ID", "IP"], m = w(d(S[0])), T = w(""), h = [$.options.expires, $.options.lastSeen, "Session ID", "User ID", $.options.state, "IP"];
  we(() => {
    L("page_size=" + s(I));
  }), Pe(() => {
    let o = s(T).toLowerCase();
    s(H) ? o.length < 3 ? s(V) && (L("page_size=" + s(I)), a(V, false)) : q(o) : o ? s(m) === S[0] ? a(c, d(s(n).filter((r) => {
      var _a;
      return (_a = r.user_id) == null ? void 0 : _a.toLowerCase().includes(o);
    }))) : s(m) === S[1] ? a(c, d(s(n).filter((r) => r.id.toLowerCase().includes(o)))) : s(m) === S[2] && a(c, d(s(n).filter((r) => {
      var _a;
  ...
  async function q(o) {
    a(E, void 0), a(V, true);
    let r;
    s(m) === S[0] ? r = "userid" : s(m) === S[1] ? r = "sessionid" : r = "ip";
  ...
  async function z() {
    ...
    o.error ? a(x, d(o.error.message)) : $e();
  }
  Te(B, { children: (o, r) => {
    var t = Ve(), e = K(t), i = y(e);
    Le(i, { searchOptions: S, orderOptions: h, onChangeOrder: R, searchWidth: "min(25rem, calc(100dvw - 1rem))", get value() {
      return s(T);
    }, set value(v) {
      a(T, d(v));
    }, get searchOption() {
    ...
    N(ve, { level: -1, onclick: z, children: (v, f) => {
      j();
      var D = U();
      _(() => P(D, $.sessions.invalidateAll)), u(v, D);
