...
import { l as Ye, S as st, N as Qt, P as Xt, O as Zt, A as er, U as tr, I as rr, r as ar } from "../chunks/BaE7H8ny.js";
import { e as It } from "../chunks/BpWRzPRQ.js";
import { h as Tt } from "../chunks/i8Xqpu09.js";
import { a as F, c as K, s as je, r as sr } from "../chunks/BMbqVy6X.js";
import { C as Ge } from "../chunks/CS_Msctd.js";
import { B as xe, t as Ae, f as We, a as Et, s as vr } from "../chunks/DMkkW5Nn.js";
import { M as nr } from "../chunks/BHXYRhv2.js";
import { u as Me } from "../chunks/BQ1-pLIs.js";
import { c as $t, b as vt, d as ot, f as Ve } from "../chunks/CBGoQiUs.js";
import { B as or } from "../chunks/BV-QGn6o.js";
import { I as $e } from "../chunks/BtKnbFDH.js";
import { F as ir } from "../chunks/BS0DIDHc.js";
import { b as nt, k as lr, l as gt, m as dr } from "../chunks/BRCxk8by.js";
import { I as it } from "../chunks/Nks81rMs.js";
import { I as ur } from "../chunks/BrQ3ZRVw.js";
import { u as lt } from "../chunks/BhccdcsY.js";
import { w as cr } from "../chunks/DrJUYeRi.js";
import { W as Dt } from "../chunks/8x1xiTUd.js";
import { U as fr, D as Ct } from "../chunks/BL7yMFqm.js";
import { P as _r } from "../chunks/h7VULPdI.js";
import { I as at } from "../chunks/D6E4lNPv.js";
import { s as mr } from "../chunks/-T201g_q.js";
import { a as pr } from "../chunks/BhIBACXG.js";
import { A as gr } from "../chunks/BNw-mjZh.js";
import { I as hr } from "../chunks/Cv55insy.js";
import { T as wr } from "../chunks/DcJo-CQ6.js";
import { u as br } from "../chunks/DxHSykar.js";
import { T as ht } from "../chunks/_OE2Cq0B.js";
import { M as yr } from "../chunks/Ds6bXi0i.js";
import { C as xr } from "../chunks/GWgockW8.js";
import { T as kr } from "../chunks/CVHA2fPQ.js";
import { L as Pr } from "../chunks/BAqymMo_.js";
var Ir = k('<div class="link-err value svelte-1tea8v4"> </div>'), Tr = k('<div class="fed-btn svelte-1tea8v4"><!> <!></div>'), Er = k('<h3> </h3> <p> </p> <div class="providers svelte-1tea8v4"></div>', 1), $r = k("<!> <!>", 1), Dr = k('<div><div> </div> <span class="value svelte-1tea8v4"> </span></div>'), Cr = k('<div><div> </div> <span class="value svelte-1tea8v4"> </span></div>'), Nr = k('<div><div>WebID:</div> <span class="value svelte-1tea8v4"><a target="_blank"><!></a></span></div>'), Mr = k('<div><div><div> </div> <span class="value svelte-1tea8v4"> </span></div> <div><div> </div> <span class="value svelte-1tea8v4"> </span></div> <div><div> </div> <span class="value svelte-1tea8v4"> </span></div> <div><div> </div> <span class="value svelte-1tea8v4"> </span></div> <div><div> </div> <div><div class="value svelte-1tea8v4"> </div> <!></div></div> <div><div> </div> <span class="value svelte-1tea8v4"> </span></div> <div><div> </div> <span class="value svelte-1tea8v4"> </span></div> <div><div> </div> <!></div> <div><div> </div> <!></div> <div><div> </div> <!></div> <!> <div><div> </div> <span class="value svelte-1tea8v4"> </span></div> <div><div> </div> <span class="value svelte-1tea8v4"> </span></div> <!> <!></div>');
function wt(se, f) {
  De(f, true);
  let s = Te(f, "user", 15), r = Me(), N = T(false), i = T(false), M = he(() => {
    var _a;
    return (_a = s().account_type) == null ? void 0 : _a.startsWith("federated");
  }), w = he(() => {
    var _a;
    return e(M) ? `${s().account_type}: ${((_a = f.authProvider) == null ? void 0 : _a.name) || ""}` : s().account_type;
  ...
  async function P() {
    ...
    Y.body ? s(Y.body) : (console.error(Y.error), n(N, true));
  }
  var q = Mr(), B = a(q), Z = a(B), ve = a(Z, true);
  t(Z);
  var L = v(Z, 2), E = a(L, true);
  t(L), t(B);
  var O = v(B, 2), H = a(O), ae = a(H, true);
  t(H);
  var ee = v(H, 2), te = a(ee, true);
  t(ee), t(O);
  var S = v(O, 2), I = a(S), _ = a(I, true);
  t(I);
      ...
      var J = fe(), oe = j(J);
      {
        var me = (ce) => {
          ...
          nr(ze, { get showModal() {
            ...
            var Se = Er(), et = j(Se), Ot = a(et, true);
            t(et);
            var tt = v(et, 2), Kt = a(tt, true);
            t(tt);
            var mt = v(tt, 2);
            It(mt, 21, () => f.providers, (rt) => rt.id, (rt, pt) => {
              ...
              l(Ot, r.account.providerLink), l(Kt, r.account.providerLinkDesc);
            }), o(Re, Se);
  ...
  t(ue), t(R);
  var Ee = v(R, 2), Ne = a(Ee), Xe = a(Ne, true);
  t(Ne);
  var Ze = v(Ne, 2);
  ...
  var Le = v(Ee, 2), Ue = a(Le), Nt = a(Ue, true);
  t(Ue);
  var Mt = v(Ue, 2);
  Ge(Mt, { get checked() {
    return s().enabled;
  ...
  var ut = v(Fe, 2);
  {
    var zt = (Y) => {
      ...
      t(ce), t(J), C((Pe) => {
        F(J, 1, K(e(d)), "svelte-1tea8v4"), F(oe, 1, K(e(y)), "svelte-1tea8v4"), l(me, r.account.lastLogin), l(ye, Pe);
  ...
  var Be = v(ut, 2), Oe = a(Be), Wt = a(Oe, true);
  t(Oe);
  var ct = v(Oe, 2), Rt = a(ct, true);
  t(ct), t(Be);
  var Ke = v(Be, 2), He = a(Ke), St = a(He, true);
  t(He);
  ...
  var _t = v(Ke, 2);
  {
    var Ut = (Y) => {
      ...
      var ce = v(oe, 2), ye = a(ce, true);
      t(ce), t(J), C((Pe) => {
        F(J, 1, K(e(d)), "svelte-1tea8v4"), F(oe, 1, K(e(y)), "svelte-1tea8v4"), l(me, r.account.userExpiry), l(ye, Pe);
  ...
  {
    var qt = (Y) => {
      var J = Nr(), oe = a(J), me = v(oe, 2), ce = a(me), ye = a(ce);
      Tt(ye, () => st(s().id).replace("/auth/", "/auth/<wbr/>")), t(ce), t(me), t(J), C((Pe) => {
        F(J, 1, K(e(d)), "svelte-1tea8v4"), F(oe, 1, K(e(y)), "svelte-1tea8v4"), je(ce, "href", Pe);
      }, [() => st(s().id)]), o(Y, J);
    };
    x(Ft, (Y) => {
      f.webIdData && Y(qt);
  ...
  t(q), C((Y, J) => {
    F(B, 1, K(e(d)), "svelte-1tea8v4"), F(Z, 1, K(e(y)), "svelte-1tea8v4"), l(ve, r.common.email), l(E, s().email), F(O, 1, K(e(d)), "svelte-1tea8v4"), F(H, 1, K(e(y)), "svelte-1tea8v4"), l(ae, r.account.givenName), l(te, s().given_name), F(S, 1, K(e(d)), "svelte-1tea8v4"), F(I, 1, K(e(y)), "svelte-1tea8v4"), l(_, r.account.familyName), l(u, s().family_name), F(V, 1, K(e(d)), "svelte-1tea8v4"), F(re, 1, K(e(y)), "svelte-1tea8v4"), l(de, `${r.account.user ?? ""} ID`), l($, s().id), F(g, 1, K(e(d)), "svelte-1tea8v4"), F(U, 1, K(e(y)), "svelte-1tea8v4"), l(Q, r.account.accType), l(ne, e(w) || ""), F(b, 1, K(e(d)), "svelte-1tea8v4"), F(p, 1, K(e(y)), "svelte-1tea8v4"), l(z, r.account.roles), l(ge, s().roles || "None"), F(R, 1, K(e(d)), "svelte-1tea8v4"), F(D, 1, K(e(y)), "svelte-1tea8v4"), l(_e, r.account.groups), l(Ie, s().groups || "None"), F(Ee, 1, K(e(d)), "svelte-1tea8v4"), F(Ne, 1, K(e(y)), "svelte-1tea8v4"), l(Xe, r.account.mfaActivated), F(Le, 1, K(e(d)), "svelte-1tea8v4"), F(Ue, 1, K(e(y)), "svelte-1tea8v4"), l(Nt, r.account.userEnabled), F(Fe, 1, K(e(d)), "svelte-1tea8v4"), F(qe, 1, K(e(y)), "svelte-1tea8v4"), l(Lt, r.account.emailVerified), F(Be, 1, K(e(d)), "svelte-1tea8v4"), F(Oe, 1, K(e(y)), "svelte-1tea8v4"), l(Wt, r.account.passwordExpiry), l(Rt, Y), F(Ke, 1, K(e(d)), "svelte-1tea8v4"), F(He, 1, K(e(y)), "svelte-1tea8v4"), l(St, r.account.userCreated), l(Vt, J);
...
function bt(se, f) {
  ...
  let r = Me(), N = T(""), i = T(false), M = T(false);
  async function w(G, P) {
    var _a2;
    const q = P.get("email"), B = P.get("family_name") || void 0, Z = P.get("given_name") || void 0, ve = P.get("birthdate") || void 0, L = ((_a2 = P.get("phone")) == null ? void 0 : _a2.replaceAll(" ", "")) || void 0, E = P.get("street") || void 0, O = P.get("zip") || void 0, H = O ? Number.parseInt(O) : void 0, ae = P.get("city") || void 0, ee = P.get("country") || void 0;
    ...
    if (S.body) {
      n(i, true), s(S.body);
      let I = 3e3;
      S.status === 202 && (n(M, true), I = 3e4), setTimeout(() => {
        n(i, false);
      }, I);
    } else S.error && (console.error(S.error), n(N, h(S.error.message)));
  }
  var d = Rr(), y = a(d);
      ...
      var m = (g) => {
        ...
        var U = fe(), Q = j(U);
        {
          var ie = (W) => {
            ...
            t(ne), C(() => l(le, e(N))), Ae(3, ne, () => We), o(W, ne);
          };
          x(Q, (W) => {
            e(N) && W(ie);
          }, true);
...
var Sr = k('<div class="err svelte-16mlupu"><b>Your browser does not support Webauthn credentials and must be updated.</b></div>'), Vr = k('<!> <div class="regBtns svelte-16mlupu"><!> <!></div>', 1), Ur = k('<div class="regNewBtn svelte-16mlupu"><!></div>'), Fr = k('<div class="keysHeader svelte-16mlupu"> </div>'), qr = k('<div class="button svelte-16mlupu"><!></div>'), Br = k('<!> <p class="svelte-16mlupu"> <br><br> </p> <!> <!> <div class="keysContainer svelte-16mlupu"></div> <!> <div> </div>', 1), Or = k('<div class="container svelte-16mlupu"><!></div>');
function yt(se, f) {
  De(f, true);
  const s = "credentials" in navigator;
  let r = Me(), N = lt("account"), i = he(() => {
    var _a;
    return (_a = N.get()) == null ? void 0 : _a.user_id;
  }), M = T(void 0), w = T(false), d = T(""), y = T(false), c = T(f.user.account_type === "password"), G = T(void 0), P = T(""), q = T(false), B = T(h([]));
  Qe(() => {
    ve();
  }), Je(() => {
  ...
  async function ve() {
    var _a;
    let I = await Ve(`/auth/v1/users/${(_a = N.get()) == null ? void 0 : _a.user_id}/webauthn`);
...
var Kr = k('<div class="container svelte-ue7bk2"><!> <!> <!> <!> <div class="btn svelte-ue7bk2"><!></div> <div class="err svelte-ue7bk2"> </div></div>');
function Hr(se, f) {
  De(f, true);
  let s = Te(f, "passwords", 15), r = Te(f, "hideCurrentPassword", 3, false), N = Te(f, "isValid", 15), i = Me();
  N(P);
  let M = T(false), w = T(""), d = T(void 0), y = he(() => {
    var _a;
  ...
  function P() {
    return n(w, ""), !r() && !s().current ? (n(w, h(i.account.passwordCurrReq)), false) : s().new ? s().newConfirm ? e(M) ? s().new.length > 256 ? (n(w, "max 256"), false) : s().new !== s().newConfirm ? (n(w, h(i.account.passwordNoMatch)), false) : true : (n(w, h(i.account.passwordPolicyFollow)), false) : (n(w, h(i.account.passwordNewReq)), false) : (n(w, h(i.account.passwordNewReq)), false);
  }
  function q() {
    if (n(w, ""), e(d)) {
      let L = er(e(d));
...
function xt(se, f) {
  De(f, true);
  let s = Te(f, "user", 15), r = Me(), N = he(() => f.viewModePhone ? "calc(100vw - 1.5rem)" : "300px"), i = T(h(s().account_type)), M = T(h([])), w = T(void 0), d = T(false), y = T(false), c = T(""), G = T(false), P = T(void 0), q = T(h({ current: "", new: "", newConfirm: "" })), B = he(() => e(M).filter((m) => m.user_verified).length > 0);
  Qe(() => {
    Z();
  });
  async function Z() {
    let m = await Ve(`/auth/v1/users/${s().id}/webauthn`);
    m.body ? n(M, h(m.body)) : console.error("error fetching passkeys: " + m.error);
  }
  async function ve() {
  ...
  async function L() {
    n(c, ""), e(M).length > 0 ? await E() : await O();
  }
  async function E() {
    var _a;
  ...
  function ae(m) {
    n(P, void 0), m && "code" in m && O(m.code);
  }
  async function ee() {
  ...
  var re = v(u, 2);
  {
    var de = (m) => {
      var $ = Zr(), g = j($), U = a(g);
      const Q = he(() => !(e(i) === "password" && e(M).length < 1));
      Hr(U, { get inputWidth() {
        return e(N);
            ...
            var ge = (D) => {
              ...
              var _e = fe(), ue = j(_e);
              {
                var Ie = (Ee) => {
                  ...
                  }, $$slots: { default: true } }), t(Ne), o(Ee, Ne);
                };
                x(ue, (Ee) => {
                  e(d) && !e(y) && Ee(Ie);
                }, true);
...
function kt(se, f) {
  let s = Te(f, "checked", 15, false), r = Te(f, "ariaLabel", 3, ""), N = Te(f, "name", 3, "");
  function i() {
    s(!s());
  }
  var M = ra(), w = a(M), d = a(w);
  mr(d, () => f.children), t(w);
  var y = v(w, 2), c = a(y);
  sr(c), c.__click = i, c.__keydown = [ta, i], pe(2), t(y), t(M), C(() => {
    Et(w, "width", f.labelWidth), je(c, "name", N()), c.disabled = f.disabled, je(c, "aria-checked", s()), je(c, "aria-label", r());
  }), pr(c, s), o(se, M);
}
jt(["click", "keydown"]);
...
function Pt(se, f) {
  De(f, true);
  let s = Te(f, "webIdData", 15), r = Me();
  const N = "14rem";
  let i = T(""), M = T(false), w = T(!!s().custom_triples), d = st(s().user_id);
  async function y() {
    n(i, "");
    let _ = await ot(`/auth/v1/users/${s().user_id}/webid/data`, s());
    _.error ? n(i, h(_.error.message)) : (n(M, true), setTimeout(() => {
      n(M, false);
    }, 3e3));
  }
  ...
  var Z = v(q, 2), ve = a(Z);
  kt(ve, { ariaLabel: "E-Mail", labelWidth: N, get checked() {
...
function ca(se, f) {
  ...
  const s = (E) => {
    var O = ia(), H = a(O, true);
    t(O), C(() => l(H, `${r().given_name} ${r().family_name || ""}`)), o(E, O);
  };
  let r = Te(f, "user", 15), N = Te(f, "webIdData", 15), i = Me(), M = T(void 0), w = T(h([])), d = he(() => {
    var _a;
    if ((_a = r().account_type) == null ? void 0 : _a.startsWith("federated")) return e(w).filter((E) => E.id === r().auth_provider_id)[0];
  }), y = he(() => e(M) && e(M) < 500), c = T(h(i.account.navInfo)), G = h(N() ? [i.account.navInfo, i.account.navEdit, i.common.password, i.account.navMfa, "WebID", i.account.devices, i.account.navLogout] : [i.account.navInfo, i.account.navEdit, i.common.password, i.account.navMfa, i.account.devices, i.account.navLogout]);
  Qe(() => {
  ...
  t(B), Jt("innerWidth", (E) => n(M, h(E))), o(se, P), Ce();
}
var fa = k("<!> <!> <!>", 1);
function Za(se, f) {
  De(f, true);
  let s = Me(), r = lt("account"), N = T(void 0), i = T(void 0), M = T(false);
  Je(() => {
    let d = r.get();
    d && w(d);
  });
  async function w(d) {
    ...
    if (y) {
      ...
      c[0].body ? n(N, h(c[0].body)) : ar("account"), c[1].body ? n(i, h(c[1].body)) : c[1].status === 404 && n(i, h({ user_id: y, expose_email: false })), n(M, true);
    } else console.error("no user_id in session");
  }
  Gt((d) => {
    C(() => {
      var _a;
      return Yt.title = `${(s == null ? void 0 : s.account.account) || "Account"} ${((_a = e(N)) == null ? void 0 : _a.email) ?? ""}`;
    });
  }), yr(se, { children: (d, y) => {
    xr(d, { children: (c, G) => {
      var P = fa(), q = j(P);
