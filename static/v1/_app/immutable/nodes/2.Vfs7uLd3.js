...
import { p as he, a5 as Se, l as A, k as H, f as Y, j as t, a as me, c as h, r as d, t as p, a9 as ge, s as g, aa as se, a8 as Z, a7 as E, aj as je, a6 as Te } from "../chunks/CvlvO1XB.js";
import { s as B, e as Me, h as Ee } from "../chunks/CTI4QPiR.js";
import { i as ee } from "../chunks/BUO_AUgz.js";
import { h as be } from "../chunks/i8Xqpu09.js";
import { s as ue } from "../chunks/-T201g_q.js";
import { p as P } from "../chunks/Wh68IIk2.js";
...
import { s as o, a as Pe } from "../chunks/BMbqVy6X.js";
import { T as Ie } from "../chunks/Cbuxv9a6.js";
import { L as Ce } from "../chunks/Pcv4BnHP.js";
import { p as Be } from "../chunks/DlDtjbc8.js";
import { f as ze, b as Ve } from "../chunks/tF66aiNY.js";
import { R as qe } from "../chunks/BfJ5aiUK.js";
import { A as We } from "../chunks/BqWmWZH3.js";
...
import { S as Re, k as pe, i as Ze, B as $e } from "../chunks/B21bTIl7.js";
import { T as Ue } from "../chunks/BmpEzKyJ.js";
import { u as De } from "../chunks/cwCl71UF.js";
import { e as Ge } from "../chunks/BpWRzPRQ.js";
import { E as Ke } from "../chunks/bo6FEOVM.js";
import { u as Fe } from "../chunks/CUqQZdNU.js";
import { O as Je } from "../chunks/D1anwFsC.js";
...
function Ye(c, r) {
  ...
  async function l() {
    ...
    _.body ? A(a, P(_.body)) : console.error(_.error);
  }
  var i = ce(), e = Y(i);
  {
    var y = (_) => {
      var z = ce(), I = Y(z);
      {
        var R = (k) => {
          ...
          d(x), d(u), p(() => {
            o(x, "href", t(a).latest_url), B(M, `v${t(a) ?? ""} \u26A0\uFE0F`);
          }), n(k, u);
        }, S = (k) => {
          var u = Xe(), x = h(u);
          d(u), p(() => B(x, `v${t(a).current ?? ""}`)), n(k, u);
        };
        ee(I, (k) => {
  ...
  We(c, { get href() {
    ...
    var _ = ce(), z = Y(_);
    {
      var I = (S) => {
        ...
        ue(x, () => r.icon, () => t(l)), d(u);
        var M = g(u, 2), L = h(M);
        ue(L, () => r.children), d(M), d(k), n(S, k);
      }, R = (S) => {
        var k = tt(), u = h(k), x = h(u);
        ue(x, () => r.icon, () => t(l)), d(u);
        var M = g(u, 2), L = h(M);
        ue(L, () => r.children), d(M), d(k), p(() => ve(u, "width", t(l))), n(S, k);
      };
      ee(z, (S) => {
        r.compact ? S(I) : S(R, false);
      });
    }
    n(e, _);
  }, $$slots: { default: true } });
...
function Ot(c, r) {
  ...
  se(() => {
    ...
    t(_) && t(_) < 600 && Be.url && A(y, true);
  }), se(() => {
    A(y, P(t(_) && t(_) < 800 || false));
  }), se(() => {
    A(e, P(t(_) && t(_) < 1280 || false));
  });
  function z() {
    A(l, true);
  }
  ...
  var k = Nt(), u = h(k), x = h(u), M = h(x), L = h(M), X = h(L), U = h(X);
  de(U, { ariaControls: "mainNav", invisible: true, onclick: R, children: (C, j) => {
    var F = St(), re = h(F);
    ot(re, {}), d(F), n(C, F);
  }, $$slots: { default: true } }), d(X);
  var D = g(X, 2);
  {
    var te = (C) => {
      var j = Tt(), F = h(j);
  ...
  var G = g(M, 2);
  {
    var w = (C) => {
      ...
      $(Le, { get compact() {
        ...
        E();
        var f = T();
        p(() => B(f, a.nav.docs)), n(s, f);
      } }), d(J), p(() => ve(J, "margin-top", t(e) ? ".5rem" : "1.5rem")), n(C, j);
    };
    ee(G, (C) => {
      t(y) || C(w);
    });
  ...
  }), _e("innerWidth", (C) => A(_, P(C))), Me("mouseenter", k, z), Me("mouseleave", k, I), n(c, k), me();
}
...
function Zt(c, r) {
  ...
  var y = g(i, 2);
  let _;
  var z = h(y), I = g(z, 2), R = g(I, 2), S = g(R, 2);
  d(y), d(l), p((k, u, x, M) => {
    B(e, a.common.legend), _ = Pe(y, 1, "svelte-1vtgp8q", null, _, { wide: r.wide }), ve(z, "border-color", k), ve(I, "border-color", u), ve(R, "border-color", x), ve(S, "border-color", M);
...
function Ut(c, r) {
  he(r, true);
  const a = 50;
  let l = we(), i = H(void 0), e = H(false), y = H(void 0), _ = H(P([])), z = H(P([])), I = H(P(Ze() && localStorage.getItem("eventLevel") || "info")), R = "";
  je(() => {
    var _a;
    ...
    switch (t(I)) {
      case "info":
        ...
        break;
      case "notice":
        A(z, P(t(_).filter((w) => w.typ === "Test" || w.level === "notice" || w.level === "warning" || w.level === "critical")));
        break;
      case "warning":
        A(z, P(t(_).filter((w) => w.typ === "Test" || w.level === "warning" || w.level === "critical")));
        break;
      case "critical":
        A(z, P(t(_).filter((w) => w.typ === "Test" || w.level === "critical")));
        break;
    }
  });
  async function S() {
  ...
  function k() {
    var _a, _b;
    localStorage.setItem("eventLevel", t(I)), ((_a = t(y)) == null ? void 0 : _a.readyState) !== 2 && ((_b = t(y)) == null ? void 0 : _b.close()), A(y, P(new EventSource(`/auth/v1/events/stream?latest=${a}&level=${t(I).toLowerCase()}`))), t(y).onopen = () => {
      A(_, P([]));
    }, t(y).onerror = () => {
      ...
      if (w.data) {
        ...
        console.log("event", K.id), A(_, P([K, ...t(_).slice(-499)]));
      }
    };
  }
  var u = $t();
  let x;
  var M = h(u), L = h(M), X = h(L), U = g(h(X), 2);
  Je(U, { get ariaLabel() {
  ...
  Zt(G, { get wide() {
    return t(e);
  } }), d(u), p(() => x = Pe(u, 1, "svelte-zmipc9", null, x, { wide: t(e), narrow: !t(e) })), _e("innerWidth", (w) => A(i, P(w))), n(c, u), me();
}
...
function Mr(c, r) {
  ...
  {
    var S = (u) => {
      var x = Dt(), M = h(x), L = h(M), X = h(L);
      be(X, () => a.error.noAdmin), d(L);
      var U = g(L, 2);
      de(U, { onclick: () => window.location.href = "/auth/v1/account", children: (D, te) => {
        E();
        var G = T();
        p(() => B(G, a.common.account)), n(D, G);
        ...
        var L = (U) => {
          ...
          var D = ce(), te = Y(D);
          {
            var G = (w) => {
              ...
              var C = g(ae, 2);
              He(C, { children: (j, F) => {
                var re = Ft(), ie = Y(re), J = h(ie);
                ue(J, () => r.children), d(ie);
                var V = g(ie, 2);
                {
                  var O = (q) => {
                    var W = Kt(), oe = h(W);
  ...
  _e("innerWidth", (u) => A(i, P(u))), n(c, I), me();
}
export {
  Mr as component
};
