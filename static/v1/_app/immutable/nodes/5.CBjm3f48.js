import { t as k, a as o, e as we, d as fe } from "../chunks/D8nUqfqE.js";
import { p as De, c as a, r as t, s as v, j as e, a9 as he, t as C, a as Ce, a7 as pe, k as T, f as j, l as n, a5 as Je, aa as Qe, a6 as Yt } from "../chunks/D-nwkJyM.js";
import { s as l, d as jt, h as Gt } from "../chunks/DmLjbmU6.js";
import { i as x } from "../chunks/C3XMhfdI.js";
import { p as h } from "../chunks/BiI21XkS.js";
import { b as Qt } from "../chunks/Crgqrr3Z.js";
import { p as Te } from "../chunks/2rFDT0Lm.js";
import { l as Ye, Q as st, _ as Jt, P as Xt, N as Zt, A as er, S as tr, I as rr, r as ar } from "../chunks/DppGgfa0.js";
import { e as It } from "../chunks/6MDunRKZ.js";
import { h as Tt } from "../chunks/1rF6JvjJ.js";
import { a as F, c as K, s as je, r as sr } from "../chunks/D_HYGYLR.js";
import { C as Ge } from "../chunks/BSpE3f0b.js";
import { B as xe, t as Ae, f as We, a as Et, s as vr } from "../chunks/BUAPoI3e.js";
import { M as nr } from "../chunks/D4OK0IqS.js";
import { u as Ne } from "../chunks/CMjKUQkH.js";
import { c as $t, b as vt, d as ot, f as Ve } from "../chunks/emZtalxW.js";
import { B as or } from "../chunks/BJ-m233v.js";
import { I as $e } from "../chunks/BE8gxf21.js";
import { F as ir } from "../chunks/BgEKkuL8.js";
import { b as nt, k as lr, l as gt, m as dr } from "../chunks/BRCxk8by.js";
import { I as it } from "../chunks/C0_UZAx3.js";
import { I as ur } from "../chunks/RN-bweNU.js";
import { u as lt } from "../chunks/B899WTRX.js";
import { w as cr } from "../chunks/CipIJy_t.js";
import { W as Dt } from "../chunks/BMTjKwwr.js";
import { U as fr, D as Ct } from "../chunks/B1UlKktF.js";
import { P as _r } from "../chunks/Drrpav8g.js";
import { I as at } from "../chunks/Bw4crv1X.js";
import { s as mr } from "../chunks/ivlJJTAR.js";
import { a as pr } from "../chunks/DAX5MQt8.js";
import { A as gr } from "../chunks/Ch0F_Zoj.js";
import { I as hr } from "../chunks/1FH525aw.js";
import { T as wr } from "../chunks/Bzn2dU6j.js";
import { u as br } from "../chunks/C6Ehfmfa.js";
import { T as ht } from "../chunks/C1ZebG9t.js";
import { M as yr } from "../chunks/C-ghU9Ac.js";
import { C as xr } from "../chunks/BQuV3eOZ.js";
import { T as kr } from "../chunks/DmGHSNVM.js";
import { L as Pr } from "../chunks/DJrws3yD.js";
...
function wt(se, f) {
  ...
  function c(Y) {
    Jt(64, (Q, { challenge: oe, verifier: me }) => {
      Q || (localStorage.setItem(Xt, me), G(Y, oe));
    });
  }
  async function G(Y, Q) {
    let oe = { email: s().email, client_id: "rauthy", redirect_uri: window.location.href, provider_id: Y, pkce_challenge: Q }, me = await vt(`/auth/v1/providers/${Y}/link`, oe);
    if (me.text) {
      Zt(me.text);
  ...
  {
    var zt = (Y) => {
      var Q = Dr(), oe = a(Q), me = a(oe, true);
      t(oe);
      var ce = v(oe, 2), ye = a(ce, true);
      t(ce), t(Q), C((Pe) => {
        F(Q, 1, K(e(d)), "svelte-1tea8v4"), F(oe, 1, K(e(y)), "svelte-1tea8v4"), l(me, r.account.lastLogin), l(ye, Pe);
      }, [() => Ye(s().last_login)]), o(Y, Q);
    };
    x(ut, (Y) => {
      s().last_login && Y(zt);
    });
  ...
  {
    var Ut = (Y) => {
      var Q = Cr(), oe = a(Q), me = a(oe, true);
      t(oe);
      var ce = v(oe, 2), ye = a(ce, true);
      t(ce), t(Q), C((Pe) => {
        F(Q, 1, K(e(d)), "svelte-1tea8v4"), F(oe, 1, K(e(y)), "svelte-1tea8v4"), l(me, r.account.userExpiry), l(ye, Pe);
      }, [() => Ye(s().user_expires)]), o(Y, Q);
    };
    x(_t, (Y) => {
      s().user_expires && Y(Ut);
    });
  ...
  {
    var qt = (Y) => {
      var Q = Mr(), oe = a(Q), me = v(oe, 2), ce = a(me), ye = a(ce);
      Tt(ye, () => st(s().id).replace("/auth/", "/auth/<wbr/>")), t(ce), t(me), t(Q), C((Pe) => {
        F(Q, 1, K(e(d)), "svelte-1tea8v4"), F(oe, 1, K(e(y)), "svelte-1tea8v4"), je(ce, "href", Pe);
      }, [() => st(s().id)]), o(Y, Q);
    };
    x(Ft, (Y) => {
      f.webIdData && Y(qt);
  ...
  t(q), C((Y, Q) => {
    F(B, 1, K(e(d)), "svelte-1tea8v4"), F(Z, 1, K(e(y)), "svelte-1tea8v4"), l(ve, r.common.email), l(E, s().email), F(O, 1, K(e(d)), "svelte-1tea8v4"), F(H, 1, K(e(y)), "svelte-1tea8v4"), l(ae, r.account.givenName), l(te, s().given_name), F(S, 1, K(e(d)), "svelte-1tea8v4"), F(I, 1, K(e(y)), "svelte-1tea8v4"), l(_, r.account.familyName), l(u, s().family_name), F(V, 1, K(e(d)), "svelte-1tea8v4"), F(re, 1, K(e(y)), "svelte-1tea8v4"), l(de, `${r.account.user ?? ""} ID`), l($, s().id), F(g, 1, K(e(d)), "svelte-1tea8v4"), F(U, 1, K(e(y)), "svelte-1tea8v4"), l(J, r.account.accType), l(ne, e(w) || ""), F(b, 1, K(e(d)), "svelte-1tea8v4"), F(p, 1, K(e(y)), "svelte-1tea8v4"), l(z, r.account.roles), l(ge, s().roles || "None"), F(R, 1, K(e(d)), "svelte-1tea8v4"), F(D, 1, K(e(y)), "svelte-1tea8v4"), l(_e, r.account.groups), l(Ie, s().groups || "None"), F(Ee, 1, K(e(d)), "svelte-1tea8v4"), F(Me, 1, K(e(y)), "svelte-1tea8v4"), l(Xe, r.account.mfaActivated), F(Le, 1, K(e(d)), "svelte-1tea8v4"), F(Ue, 1, K(e(y)), "svelte-1tea8v4"), l(Mt, r.account.userEnabled), F(Fe, 1, K(e(d)), "svelte-1tea8v4"), F(qe, 1, K(e(y)), "svelte-1tea8v4"), l(Lt, r.account.emailVerified), F(Be, 1, K(e(d)), "svelte-1tea8v4"), F(Oe, 1, K(e(y)), "svelte-1tea8v4"), l(Wt, r.account.passwordExpiry), l(Rt, Y), F(Ke, 1, K(e(d)), "svelte-1tea8v4"), F(He, 1, K(e(y)), "svelte-1tea8v4"), l(St, r.account.userCreated), l(Vt, Q);
...
function bt(se, f) {
  ...
  ir(y, { get action() {
    ...
    xe(u, { type: "submit", children: (g, U) => {
      pe();
      var J = we();
      C(() => l(J, r.common.save)), o(g, J);
    }, $$slots: { default: true } }), t(A);
    var V = v(A, 2);
    {
      var re = (g) => {
        var U = Lr(), J = a(U);
        it(J, {}), t(U), Ae(3, U, () => We), o(g, U);
      };
      x(V, (g) => {
        e(i) && g(re);
      });
    ...
    var de = v(_, 2);
    {
      var m = (g) => {
        var U = Ar(), J = a(U, true);
        t(U), C(() => l(J, r.account.emailUpdateConfirm)), o(g, U);
      }, $ = (g) => {
        var U = fe(), J = j(U);
        {
          var ie = (W) => {
...
var Yr = k('<div class="m-05 svelte-1h4zvzu"><p> </p> <p><b> </b></p> <div></div> <p> </p> <!></div>'), jr = k("<p> </p> <p> </p> <p> </p> <div><!></div>", 1), Gr = k('<div class="success svelte-1h4zvzu"><!></div>'), Qr = k('<div class="err"> </div>'), Jr = k('<div class="cancel"><!></div>'), Xr = k('<div class="convertPasskey svelte-1h4zvzu"><h3> </h3> <p> </p> <!></div>'), Zr = k('<div><!> <div class="save svelte-1h4zvzu"><!> <!></div></div> <!>', 1), ea = k('<div class="container svelte-1h4zvzu"><!> <!> <!> <!></div>');
function xt(se, f) {
  De(f, true);
  ...
  async function L() {
    n(c, ""), e(N).length > 0 ? await E() : await O();
  }
  async function E() {
    var _a;
  ...
  var _ = v(S, 2);
  {
    var A = (m) => {
      ...
      t(g);
      var J = v(g, 2), ie = a(J), W = a(ie, true);
      t(ie), t(J);
      var ne = v(J, 2);
      Et(ne, "height", ".3rem");
  ...
  var u = v(_, 2);
  {
    var V = (m) => {
      ...
      t(g);
      var J = v(g, 2), ie = a(J, true);
      t(J);
      var W = v(J, 2), ne = a(W, true);
      t(W);
  ...
  var re = v(u, 2);
  {
    var de = (m) => {
      var $ = Zr(), g = j($), U = a(g);
      const J = he(() => !(e(i) === "password" && e(N).length < 1));
      Hr(U, { get inputWidth() {
        return e(M);
...
function ca(se, f) {
          ...
          var V = fe(), re = j(V);
          {
            var de = ($) => {
              ...
              var g = fe(), U = j(g);
              {
                ...
                x(U, (W) => {
                  e(c) === i.common.password ? W(J) : W(ie, false);
                }, true);
              }
              o($, g);
            };
  ...
  t(B), Qt("innerWidth", (E) => n(N, h(E))), o(se, P), Ce();
}
var fa = k("<!> <!> <!>", 1);
function Za(se, f) {
  De(f, true);
