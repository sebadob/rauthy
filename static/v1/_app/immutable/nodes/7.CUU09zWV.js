...
import { p as X, aa as J, s as u, c as v, a8 as _e, a as Z, a7 as B, t as N, j as e, a9 as j, r as c, k as T, l as s, f as R, a5 as ke } from "../chunks/CvlvO1XB.js";
...
import { B as Q, t as ee, s as te, a as de } from "../chunks/CqH8LXO-.js";
import { p as m } from "../chunks/Wh68IIk2.js";
import { d as be, c as Ce, b as Le, f as Ke } from "../chunks/BO1A6s0c.js";
import { C as De } from "../chunks/BnPoFdx3.js";
import { N as Ne } from "../chunks/xdJ7HxlL.js";
import { N as Ee } from "../chunks/TVaajnXc.js";
import { B as Ve } from "../chunks/CKd5IV8T.js";
import { u as Me } from "../chunks/EvbDpXwj.js";
import { u as re } from "../chunks/D8mHI_K9.js";
import { O as Ge } from "../chunks/V6L-Tw6V.js";
import { p as Y, r as Oe } from "../chunks/C6SR4G2t.js";
import { A as xe } from "../chunks/B21bTIl7.js";
import { I as Be } from "../chunks/Nks81rMs.js";
import { L as Re } from "../chunks/nnFaiMsH.js";
import { I as ae } from "../chunks/BXwFLokg.js";
import { I as we } from "../chunks/Dre48gu9.js";
...
import { a as Ue, b as je, c as qe, I as He } from "../chunks/BMwvmSAM.js";
import { T as We } from "../chunks/BunZbqN2.js";
import { I as Ye } from "../chunks/KD8vSltG.js";
import { j as Je } from "../chunks/BRCxk8by.js";
import { F as Qe } from "../chunks/Df37IfRm.js";
...
function he(G, i) {
  X(i, true);
  let V = Y(i, "ariaLabel", 3, ""), o = Y(i, "value", 3, ""), L = Y(i, "rows", 3, 10), l = Y(i, "cols", 3, 60), x = Y(i, "show", 15, false), b = Y(i, "width", 3, "min(25rem, calc(100dvw - .5rem))"), z = Oe(i, ["$$slots", "$$events", "$$legacy", "ariaLabel", "value", "rows", "cols", "show", "width"]), w = le(), P = T(""), D = T("");
  J(() => {
    x() ? s(D, o()) : s(D, m(e(P)));
  }), ke(() => {
  ...
  Q(g, { get ariaLabel() {
    ...
    var a = me(), r = R(a);
    {
      var f = (E) => {
        var O = ot(), U = v(O);
        Ue(U, { width: 22 }), c(O), N(() => ne(O, "title", w.common.hide)), y(E, O);
      }, C = (E) => {
        var O = lt(), U = v(O);
        je(U, { width: 22 }), c(O), N(() => ne(O, "title", w.common.show)), y(E, O);
      };
      F(r, (E) => {
        x() ? E(f) : E(C, false);
      });
...
function ut(G, i) {
  ...
  var g = u(S, 2);
  {
    var n = (k) => {
      ...
      var E = u(f, 2), O = v(E), U = v(O), se = v(U);
      se.textContent = "API-Key <api_key>", c(U), c(O), c(E), c(r);
...
function pt(G, i) {
  ...
  N(() => M(z, o.api_key.delete1)), y(G, x), Z();
}
...
function Pt(G, i) {
  ...
  Ee(n, { paddingTop: "2.1rem", buttonTilesAriaControls: "keys", width: "min(20rem, 100dvw)", thresholdNavSub: 700, buttonTiles: (k) => {
    ...
    var f = u(a, 2);
    Ge(f, { searchOptions: P, orderOptions: w, onChangeOrder: S, searchWidth: "min(19.5rem, 100dvw - .5rem)", get searchOption() {
      return e(D);
    }, set searchOption(C) {
      s(D, m(C));
    }, get value() {
