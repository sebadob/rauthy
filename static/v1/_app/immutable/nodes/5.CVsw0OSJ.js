...
import { a as lt, b as R, c as F, s as ze, r as er } from "../chunks/BdbQ6g_y.js";
...
import { c as Ct, b as nt, d as ut, f as Ve } from "../chunks/BO1A6s0c.js";
import { B as ur } from "../chunks/CybldwDO.js";
import { U as dr, a as cr, D as Dt } from "../chunks/BbSs9vzp.js";
import { I as Ce } from "../chunks/Q4PIg3iI.js";
import { F as fr } from "../chunks/CDe-qvZi.js";
import { b as it, k as _r, l as bt, m as pr } from "../chunks/gfDO7tLr.js";
import { I as dt } from "../chunks/CTshzOVc.js";
import { I as mr } from "../chunks/cZptBaPP.js";
import { u as ct } from "../chunks/BhWvimc7.js";
import { w as gr } from "../chunks/lIqoVohd.js";
import { W as Mt } from "../chunks/Be9Mus3q.js";
...
import { A as yr } from "../chunks/D7WltQR7.js";
import { I as xr } from "../chunks/Dc2IDHgC.js";
import { T as kr } from "../chunks/BdDmaO9S.js";
import { u as Pr } from "../chunks/Cy3hLAXJ.js";
...
import { L as Cr } from "../chunks/D9_8lD-s.js";
...
function vt(ve, f) {
  ...
  let s = Ie(f, "user", 15), a = De(), k = C(false), n = C(false), E = ne(() => {
    ...
    let A = s().given_name[0];
    return s().family_name && s().family_name.length > 0 && (A += s().family_name[0]), A;
  });
  function d(A) {
    rr(64, (ee, { challenge: oe, verifier: _e }) => {
      ee || (localStorage.setItem(ar, _e), I(A, oe));
    });
  }
  async function I(A, ee) {
    let oe = { email: s().email, client_id: "rauthy", redirect_uri: window.location.href, provider_id: A, pkce_challenge: ee }, _e = await nt(`/auth/v1/providers/${A}/link`, oe);
    if (_e.text) {
      sr(_e.text);
  ...
  async function G() {
    let A = await Ct("/auth/v1/providers/link");
    A.body ? s(A.body) : (console.error(A.error), o(k, true));
  }
  var H = Rr(), J = r(H);
  lt(J, "", {}, { margin: ".5rem 0" });
  var re = r(J), W = v(re, 2);
  dr(W, { get fallbackCharacters() {
    return e(P);
  }, get userId() {
    return s().id;
    ...
    s(s().picture_id = A, true);
  } }), t(J);
  var X = v(J, 2), ae = r(X), q = r(ae, true);
  t(ae);
  var B = v(ae, 2), Z = r(B, true);
  t(B), t(X);
  var te = v(X, 2), S = r(te), T = r(S, true);
  t(S);
  var _ = v(S, 2), z = r(_, true);
  t(_), t(te);
  ...
  var ft = v(Oe, 2);
  {
    var Vt = (A) => {
      ...
      t(me), t(ee), D((Pe) => {
        R(ee, 1, F(e(i)), "svelte-1tea8v4"), R(oe, 1, F(e(w)), "svelte-1tea8v4"), l(_e, a.account.lastLogin), l(xe, Pe);
      }, [() => Qe(s().last_login)]), u(A, ee);
    };
    h(ft, (A) => {
      s().last_login && A(Vt);
    });
  ...
  var mt = v(Ge, 2);
  {
    var Kt = (A) => {
      ...
      var me = v(oe, 2), xe = r(me, true);
      t(me), t(ee), D((Pe) => {
        R(ee, 1, F(e(i)), "svelte-1tea8v4"), R(oe, 1, F(e(w)), "svelte-1tea8v4"), l(_e, a.account.userExpiry), l(xe, Pe);
      }, [() => Qe(s().user_expires)]), u(A, ee);
    };
    h(mt, (A) => {
      s().user_expires && A(Kt);
    });
  ...
  var Ot = v(mt, 2);
  {
    var Ht = (A) => {
      ...
      Tt(xe, () => ot(s().id).replace("/auth/", "/auth/<wbr/>")), t(me), t(_e), t(ee), D((Pe) => {
        R(ee, 1, F(e(i)), "svelte-1tea8v4"), R(oe, 1, F(e(w)), "svelte-1tea8v4"), ze(me, "href", Pe);
      }, [() => ot(s().id)]), u(A, ee);
    };
    h(Ot, (A) => {
      f.webIdData && A(Ht);
  ...
  t(H), D((A, ee) => {
    R(J, 1, F(e(i)), "svelte-1tea8v4"), R(re, 1, F(e(w)), "svelte-1tea8v4"), R(X, 1, F(e(i)), "svelte-1tea8v4"), R(ae, 1, F(e(w)), "svelte-1tea8v4"), l(q, a.common.email), l(Z, s().email), R(te, 1, F(e(i)), "svelte-1tea8v4"), R(S, 1, F(e(w)), "svelte-1tea8v4"), l(T, a.account.givenName), l(z, s().given_name), R(p, 1, F(e(i)), "svelte-1tea8v4"), R(Q, 1, F(e(w)), "svelte-1tea8v4"), l(Y, a.account.familyName), l(g, s().family_name), R(y, 1, F(e(i)), "svelte-1tea8v4"), R(c, 1, F(e(w)), "svelte-1tea8v4"), l(M, `${a.account.user ?? ""} ID`), l(j, s().id), R(U, 1, F(e(i)), "svelte-1tea8v4"), R(de, 1, F(e(w)), "svelte-1tea8v4"), l(pe, a.account.accType), l(N, e(m) || ""), R(se, 1, F(e(i)), "svelte-1tea8v4"), R(O, 1, F(e(w)), "svelte-1tea8v4"), l(L, a.account.roles), l(fe, s().roles || "None"), R(we, 1, F(e(i)), "svelte-1tea8v4"), R(ke, 1, F(e(w)), "svelte-1tea8v4"), l(Ae, a.account.groups), l(Ue, s().groups || "None"), R(Fe, 1, F(e(i)), "svelte-1tea8v4"), R(qe, 1, F(e(w)), "svelte-1tea8v4"), l(Lt, a.account.mfaActivated), R(Be, 1, F(e(i)), "svelte-1tea8v4"), R(Ke, 1, F(e(w)), "svelte-1tea8v4"), l(Wt, a.account.userEnabled), R(Oe, 1, F(e(i)), "svelte-1tea8v4"), R(He, 1, F(e(w)), "svelte-1tea8v4"), l(Rt, a.account.emailVerified), R(Ye, 1, F(e(i)), "svelte-1tea8v4"), R(je, 1, F(e(w)), "svelte-1tea8v4"), l(Ut, a.account.passwordExpiry), l(Ft, A), R(Ge, 1, F(e(i)), "svelte-1tea8v4"), R(Je, 1, F(e(w)), "svelte-1tea8v4"), l(qt, a.account.userCreated), l(Bt, ee);
...
function xt(ve, f) {
  ...
  async function m(d, I) {
    var _a3;
    const G = I.get("email"), H = I.get("family_name") || void 0, J = I.get("given_name") || void 0, re = I.get("birthdate") || void 0, W = ((_a3 = I.get("phone")) == null ? void 0 : _a3.replaceAll(" ", "")) || void 0, X = I.get("street") || void 0, ae = I.get("zip") || void 0, q = ae ? Number.parseInt(ae) : void 0, B = I.get("city") || void 0, Z = I.get("country") || void 0;
    let te = { email: G, family_name: H, given_name: J };
    (re || W || X || q || B || Z) && (te.user_values = { birthdate: re, phone: W, street: X, zip: q, city: B, country: Z });
    let S = await ut(`/auth/v1/users/${s().id}/self`, te);
    if (S.body) {
      o(n, true), s(S.body);
      let T = 3e3;
      S.status === 202 && (o(E, true), T = 3e4), setTimeout(() => {
        o(n, false);
      }, T);
    } else S.error && (console.error(S.error), o(k, S.error.message, true));
  }
  var i = qr(), w = r(i);
  ...
  fr(w, { get action() {
    ...
    var W = v(re, 2);
    Ce(W, { name: "given_name", autocomplete: "given-name", get label() {
    ...
    var S = v(te, 2);
    Ce(S, { name: "country", autocomplete: "country", get label() {
...
function kt(ve, f) {
  ...
  var B = Gr(), Z = r(B);
  {
    var te = (T) => {
      ...
      var g = v(Q, 2);
      {
        var y = (N) => {
          ...
          Ce($, { autocomplete: "off", get label() {
            ...
            return a.mfa.passkeyName;
          }, maxLength: 32, pattern: it, onEnter: W, get ref() {
            return e(E);
          }, set ref(L) {
            o(E, L, true);
          }, get value() {
      ...
      var le = r(pe, true);
      t(pe), D((N) => {
        l(Y, `${a.mfa.p1 ?? ""} `), l(ue, ` ${a.mfa.p2 ?? ""}`), ie = R(pe, 1, "svelte-16mlupu", null, ie, N), l(le, e(i));
...
function Qr(ve, f) {
  ...
  Ze(async () => {
    let W = await Ve("/auth/v1/password_policy");
    W.body ? o(i, W.body, true) : console.error(W.error);
  });
  function I() {
  ...
  function G() {
    if (o(m, ""), e(i)) {
      let W = vr(e(i));
      s(s().new = W, true), s(s().newConfirm = W, true);
    }
...
function Pt(ve, f) {
  ...
  var Y = v(p, 2);
  {
    var ue = (g) => {
      ...
      var j = v(M, 2), U = r(j);
      be(U, { onclick: W, level: 1, get isLoading() {
        return e(w);
      }, children: (b, $) => {
        ge();
        var K = he();
...
function $t(ve, f) {
  ...
  t(d);
  var G = v(d, 2), H = r(G);
  yr(H, { href: i, target: "_blank", children: (_, z) => {
    var p = Re(), Q = ye(p);
  ...
  var ae = v(W, 2);
  {
    var q = (_) => {
      ...
      } }), t(z), D(() => l(Q, a.account.webIdDescData)), Me(3, z, () => ir, () => ({ duration: 150 })), u(_, z);
    };
    h(ae, (_) => {
      e(m) && _(q);
    });
