import { t as f, a as n, n as Mt, d as at, e as pe } from "../chunks/CWf9OOFK.js";
import { c, j as e, k as i, r as u, t as p, aa as V, l as t, p as St, a6 as Ut, ab as de, f as j, a as Ct, s as l, a7 as Dt, a8 as xe } from "../chunks/nlANaGLT.js";
import { e as At, b as Nt, h as qt, s as U } from "../chunks/BmMHVVX3.js";
import { i as m } from "../chunks/DOjUa9u5.js";
import { e as Ft } from "../chunks/B6azywu7.js";
import { s as K, b as Wt } from "../chunks/CZv_AhHu.js";
import { p as s } from "../chunks/5u5qd9TD.js";
import { D as Ot, F as Bt, G as Ht, H as jt, o as Gt, I as Vt, j as Kt, e as ot, l as Jt, J as Qt, P as Xt, K as Yt } from "../chunks/B21bTIl7.js";
import { B as we } from "../chunks/BEQMYyDu.js";
import { W as Zt } from "../chunks/C5gerY3H.js";
import { I as er } from "../chunks/6f3yten3.js";
import { L as tr } from "../chunks/DbogliCN.js";
import { p as Ce } from "../chunks/uWmgYd3Z.js";
import { M as rr } from "../chunks/BDnQQV_p.js";
import { C as ar } from "../chunks/DA40Z_in.js";
import { u as or } from "../chunks/DwvS5LQk.js";
import { T as G } from "../chunks/C4fNG2bJ.js";
import { u as F } from "../chunks/BTUJVHfP.js";
import { T as sr } from "../chunks/Afb0E4F7.js";
import { I as ir } from "../chunks/B88EYZjx.js";
import { b as ve } from "../chunks/BO1A6s0c.js";
import { u as st } from "../chunks/Js0GGUMw.js";
import { F as nr } from "../chunks/CmL1R98Y.js";
import { B as lr } from "../chunks/CnYwIhZ_.js";
import { R as dr } from "../chunks/CdxD-BT8.js";
var vr = f('<img alt="Client Logo" width="100%" height="100%">'), cr = f('<div class="logo svelte-1gwy16z"><!></div>');
function ur(re, P) {
  let W = i(false), v = V(() => P.updated ? `/auth/v1/clients/${P.clientId}/logo?updated=${P.updated}` : `/auth/v1/clients/${P.clientId}/logo`);
  var $ = cr(), k = c($);
  {
    var x = (I) => {
      dr(I, { width: "100%" });
      ...
      var w = vr();
      p(() => K(w, "src", e(v))), At("error", w, () => t(W, true)), Nt(w), n(I, w);
    };
    m(k, (I) => {
      e(W) || P.updated === void 0 ? I(x) : I(J, false);
    });
  }
  u($), n(re, $);
}
...
function hr(re, P) {
  let W = Ce(P, "opacity", 3, 0.9), v = Ce(P, "width", 3, "1.5rem"), $ = Ce(P, "color", 3, "currentColor");
  var k = fr();
...
function ra(re, P) {
  ...
  St(P, true);
  const W = "18rem";
  let v = or(), $ = st().get(), k = V(() => $ ? "/auth/v1/dev/authorize" : "/auth/v1/oidc/authorize"), x = F("client_id").get(), J = i(""), I = i(-1), w = i(s($ ? "/auth/v1" : "")), Q = F("redirect_uri").get(), ye = F("nonce").get(), be = ((_a = F("scope").get()) == null ? void 0 : _a.split(" ")) || [], Le = i(void 0), Pe = i(void 0), Ie = F("state").get(), ae = F("code_challenge").get(), z = F("code_challenge_method").get(), De = false, Te = i(void 0), ce = i(s([])), ue = i(void 0), X = i(false), h = i(""), oe = i(""), fe = i(""), C = i(false), O = i(false), he = i(false), _e = i(false), me = i(false), B = i(false), Ae = i(""), Re = i(false), T = i(s(F("login_hint").get() || "")), D = i(""), $e = i(""), Ne = V(() => e(C) && e(Te) !== e(T) && !e(he));
  Ut(() => {
    var _a2;
    e(C) || ((_a2 = e(Le)) == null ? void 0 : _a2.focus());
  }), de(() => {
    De && (x == null ? void 0 : x.length) && lt();
  }), de(() => {
    e(me) && setTimeout(() => {
  ...
  async function dt(r, d) {
    ...
    const y = { email: e(T), client_id: x, redirect_uri: Q, state: Ie, nonce: ye, scopes: be };
    if (ae && z && (z === "plain" || z === "S256") && (y.code_challenge = ae, y.code_challenge_method = z), e(C) && e(T) !== e(Te)) {
      if (!e(D)) {
    ...
    let E = await ve(L, y, "json", "noRedirect");
    await qe(E);
  }
  async function qe(r) {
    if (r.status === 202) {
      ...
      let y = Number.parseInt(d), L = Jt(y), E = y * 1e3 - (/* @__PURE__ */ new Date()).getTime();
      t(B, true), t(h, `${v.authorize.http429} ${L}`), t(T, ""), t(D, ""), t(C, false), setTimeout(() => {
        t(B, false), t(h, "");
      }, E);
    } else e(C) ? (t(h, s(v.authorize.invalidCredentials)), t(_e, true)) : (t(C, true), t(Ae, s(e(T))));
    t(X, false);
  }
  function vt() {
    e(C) && e(Ae) !== e(T) && (t(C, false), t(D, ""), t(h, ""));
  }
  function ct(r) {
    Qt(64, (d, { challenge: y, verifier: L }) => {
      d || (localStorage.setItem(Xt, L), ut(r, y));
    });
  }
  async function ut(r, d) {
    ...
    let y = { email: e(T) || void 0, client_id: x, redirect_uri: Q, scopes: be, state: Ie, nonce: ye, code_challenge: ae, code_challenge_method: z, provider_id: r, pkce_challenge: d }, L = await ve("/auth/v1/providers/login", y);
    if (L.text) {
      Yt(L.text);
      let E = L.headers.get("location");
      if (!E) {
        console.error("no location header set for provider login");
        return;
      }
      window.location.href = E;
    } else t(h, s(((_a2 = L.error) == null ? void 0 : _a2.message) || "Error"));
  }
  function ft(r) {
    t(ue, void 0), t(h, s(r));
  }
      ...
      var Xe = l(Qe, 2);
      {
        var bt = (a) => {
          ...
          nr(g, { get action() {
            ...
            var N = c(S);
            const R = V(() => e(B) || e(O));
            er(N, { typ: "email", name: "email", autocomplete: "email", get label() {
            ...
            p((b) => Z = Wt(S, 1, "svelte-1hxn0yc", null, Z, b), [() => ({ emailMinHeight: !e(Ne) })]), n(M, A);
          }, $$slots: { default: true } });
          var Y = l(g, 2);
          {
            var se = (M) => {
              var ie = at(), A = j(ie);
              {
                var S = (N) => {
                  ...
                  u(R), p(() => U(ee, v.authorize.signUp)), n(N, R);
                };
                m(A, (N) => {
                  e(w) ? N(S) : N(Z, false);
                });
