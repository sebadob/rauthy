import { d as vt, a as n, t as M, n as V, e as T } from "../chunks/BH6NCLk-.js";
import { p as ht, a5 as zt, l as b, k as H, f as Y, j as r, a as mt, c as h, r as d, t as p, a9 as kt, s as g, aa as st, a8 as N, a7 as E, aj as Pt, a6 as St } from "../chunks/CvlvO1XB.js";
import { s as j, e as bt, h as Tt } from "../chunks/CTI4QPiR.js";
import { i as tt } from "../chunks/BUO_AUgz.js";
import { h as Lt } from "../chunks/i8Xqpu09.js";
import { s as dt } from "../chunks/-T201g_q.js";
import { p as B } from "../chunks/Wh68IIk2.js";
import { b as gt } from "../chunks/7lxiEjMQ.js";
import { M as Et } from "../chunks/Ds6bXi0i.js";
import { a as ut, B as ct } from "../chunks/DMkkW5Nn.js";
import { s as o, a as jt } from "../chunks/BMbqVy6X.js";
import { T as Mt } from "../chunks/CVHA2fPQ.js";
import { L as At } from "../chunks/BAqymMo_.js";
import { p as Ct } from "../chunks/DtY04en8.js";
import { f as Bt, b as Ht } from "../chunks/CBGoQiUs.js";
import { A as Vt } from "../chunks/BNw-mjZh.js";
import { p as v } from "../chunks/C6SR4G2t.js";
import { I as qt } from "../chunks/Vi3uK7uO.js";
import { u as _t, i as Ot } from "../chunks/D8mHI_K9.js";
import { U as Wt, k as pt, i as Ut, D as Zt } from "../chunks/BaE7H8ny.js";
import { T as Nt } from "../chunks/BmpEzKyJ.js";
import { u as Gt } from "../chunks/BhccdcsY.js";
import { e as $t } from "../chunks/BpWRzPRQ.js";
import { E as Rt } from "../chunks/Bxr7soXm.js";
import { u as Dt } from "../chunks/BQ1-pLIs.js";
import { O as Kt } from "../chunks/BHnvQvwL.js";
  ...
  var i = vt(), t = Y(i);
  {
    var x = (_) => {
      var I = vt(), A = Y(I);
      {
        ...
        tt(A, (y) => {
          r(a).update_available ? y(Z) : y(P, false);
        });
      }
      n(_, I);
    };
...
function Ue(c, e) {
  ...
  ct($, { ariaControls: "mainNav", invisible: true, onclick: Z, children: (C, S) => {
    var K = Pe(), rt = h(K);
    oe(rt, {}), d(K), n(C, K);
  ...
  var D = g(L, 2);
  {
    var w = (C) => {
      ...
      G(xt, { get compact() {
        ...
        return r(i);
      }, route: "/config/policy", highlightIncludes: "/config/", icon: (s, m = N) => {
        Me(s, { get width() {
          return m();
        } });
      }, children: (s, m) => {
      ...
      var S = Oe();
      {
        const X = (q) => {
          ...
          ct(O, { invisible: true, onclick: () => Wt(), children: (W, ot) => {
            Nt(W, { text: "Logout", children: (nt, lt) => {
              ze(nt, {});
            }, $$slots: { default: true } });
          }, $$slots: { default: true } }), d(U), n(q, U);
        };
        var K = h(S);
        {
          var rt = (q) => {
            ...
            Mt(ot, {}), d(W);
            var nt = g(W, 2);
            At(nt, { openTop: true }), n(q, U);
          }, at = (q) => {
            var U = qe(), O = Y(U), W = h(O);
            Mt(W, {});
            var ot = g(W, 2);
            At(ot, { openTop: true });
            var nt = g(ot, 2);
...
var Ze = M('<fieldset class="svelte-1vtgp8q"><legend class="font-label svelte-1vtgp8q"> </legend> <ul><li class="svelte-1vtgp8q">Info</li> <li class="svelte-1vtgp8q">Notice</li> <li class="svelte-1vtgp8q">Warning</li> <li class="svelte-1vtgp8q">Critical</li></ul></fieldset>');
function Ne(c, e) {
  ht(e, true);
  let a = Dt();
  var l = Ze(), i = h(l), t = h(i, true);
  d(i);
  var x = g(i, 2);
  let _;
  var I = h(x), A = g(I, 2), Z = g(A, 2), P = g(Z, 2);
  d(x), d(l), p((y, u, k, L) => {
    j(t, a.common.legend), _ = jt(x, 1, "svelte-1vtgp8q", null, _, { wide: e.wide }), ut(I, "border-color", y), ut(A, "border-color", u), ut(Z, "border-color", k), ut(P, "border-color", L);
...
function $e(c, e) {
  ht(e, true);
  const a = 50;
  let l = _t(), i = H(void 0), t = H(false), x = H(void 0), _ = H(B([])), I = H(B([])), A = H(B(Ut() && localStorage.getItem("eventLevel") || "info")), Z = "";
  Pt(() => {
    var _a;
  ...
  function y() {
    var _a, _b;
    localStorage.setItem("eventLevel", r(A)), ((_a = r(x)) == null ? void 0 : _a.readyState) !== 2 && ((_b = r(x)) == null ? void 0 : _b.close()), b(x, B(new EventSource(`/auth/v1/events/stream?latest=${a}&level=${r(A).toLowerCase()}`))), r(x).onopen = () => {
      b(_, B([]));
    }, r(x).onerror = () => {
  ...
  }, options: Zt, borderless: true, get value() {
    return r(A);
  }, set value(w) {
    b(A, B(w));
  } }), d(J);
