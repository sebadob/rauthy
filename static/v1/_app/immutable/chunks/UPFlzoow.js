import { C as f } from "./B21bTIl7.js";
function l(e, n) {
  let t;
  return n === "json" ? t = { "Content-Type": "application/json", Accept: "application/json" } : t = { "Content-type": "application/x-www-form-urlencoded", Accept: "application/json" }, e !== "GET" && (t["x-csrf-token"] = localStorage.getItem(f)), t;
}
...
function d(e) {
  ...
  for (let t of Object.keys(e)) {
    let a = e[t];
    typeof a < "u" && (typeof a == "object" ? n.append(t, JSON.stringify(a)) : n.append(t, a));
  }
  return n;
}
...
async function E(e, n, t, a) {
  ...
  o.append(a, t);
  const r = await fetch(n, { method: e, headers: { "x-csrf-token": localStorage.getItem(f) || "" }, body: o });
