import { b as s, a as o } from "./DEx36zkG.js";
import { C as h, p as w } from "./Brp0G0eV.js";
async function x(n, l, c, f, u, p) {
  var _a;
  let b = { passkey_name: l, magic_link_id: u }, i = { "Content-Type": "application/json", Accept: "application/json" };
  p ? i["pwd-csrf-token"] = p : i["csrf-token"] = localStorage.getItem(h) || "";
