...
var _e, _a2;
import { t as qe, a as te, e as Fe, d as Jt } from "./CWf9OOFK.js";
import { p as Lt, k as ee, P as Uo, ab as kt, a as Ot, f as Be, l as F, j as w, s as Z, t as me, c as ue, aa as rt, a8 as We, r as le, a6 as xl, a9 as nv } from "./nlANaGLT.js";
import { s as fe } from "./BmMHVVX3.js";
import { i as ye } from "./DOjUa9u5.js";
import { e as Go, i as xh } from "./B6azywu7.js";
import { a as Zt } from "./CZv_AhHu.js";
import { p as U } from "./5u5qd9TD.js";
import { b as _h, d as _l, f as jt, c as Cl } from "./BO1A6s0c.js";
import { O as ov } from "./Np7i_reI.js";
import { P as Dl } from "./mxwYGKSe.js";
import { N as lv } from "./hmJwmp7r.js";
import { B as uv } from "./B-Kclwyq.js";
import { u as cv } from "./BTUJVHfP.js";
import { N as dv } from "./B_NGI7Kx.js";
import { C as pv } from "./BSE9YYho.js";
import { B as Et, t as Ch, s as Ph } from "./BEQMYyDu.js";
import { I as mt } from "./6f3yten3.js";
import { b as Wo, k as fv, l as Bl, m as hv } from "./BRCxk8by.js";
import { F as Pl } from "./CmL1R98Y.js";
import { u as ar } from "./DwvS5LQk.js";
import { u as Vt } from "./Bb8ybDgy.js";
import { O as qh } from "./FmRbdHbC.js";
import { I as Fo } from "./ChgGgenc.js";
import { I as bl } from "./Bnlt5G4d.js";
import { f as Qt, a as jo, b as Th } from "./DswDW5U8.js";
import { S as zo } from "./BbgojtL-.js";
import { L as Ht } from "./x5MgfX0R.js";
import { u as Sh } from "./ByEJQidz.js";
import { T as mv } from "./D-oL4W7r.js";
import { p as vv } from "./uWmgYd3Z.js";
import { l as ul, z as bv } from "./B21bTIl7.js";
import { C as yv } from "./gvhP3O7i.js";
import { I as Zo } from "./DYRiKtW9.js";
import { U as Ah, a as gv, D as Rv } from "./r5FnMDNz.js";
import { P as xv } from "./q5QlMSfk.js";
import { I as Fl } from "./B88EYZjx.js";
import { h as _v } from "./CSmZOR6t.js";
import { P as Cv, f as Pv, a as qv } from "./DRk-dg9U.js";
var Tv = qe("<div><!></div>"), Sv = qe('<div class="err"> </div>'), Av = qe("<!> <!> <!> <!> <!> <!> <!> <!> <div></div> <!> <!>", 1), wv = qe('<div class="container svelte-x7a3kj"><!></div>');
function Ev(e, t) {
  Lt(t, true);
  let a = ar(), i = Vt(), l = ee(void 0), d = ee(""), n = ee(""), P = ee(""), x = ee(""), T = rt(() => {
    var _a3;
    return (_a3 = Sh().common()) == null ? void 0 : _a3.map((m) => m);
  }), b = ee("en"), k = ee(U(Uo(() => t.roles.map((m) => ({ name: m.name, selected: false }))))), I = ee(U(Uo(() => t.groups.map((m) => ({ name: m.name, selected: false }))))), E = ee(false), V = ee(U(Qt())), D = ee(U(jo()));
  kt(() => {
  ...
  async function S(m, _) {
    var _a3, _b2;
    F(d, "");
    let R = { email: w(n), given_name: w(P), family_name: w(x) || void 0, language: w(b), groups: w(I).filter((A) => A.selected).map((A) => A.name), roles: w(k).filter((A) => A.selected).map((A) => A.name), user_expires: Th(w(V), w(D)) };
...
var kv = qe("<div><!></div>"), Iv = qe('<div class="svelte-un626g"><!></div>'), Mv = qe('<div class="err"> </div>'), Lv = qe('<!> <div class="values svelte-un626g"><div class="svelte-un626g"><!></div> <div class="svelte-un626g"><!></div></div> <div class="values svelte-un626g"><div class="svelte-un626g"><!> <!> <!> <!> <!></div> <div class="svelte-un626g"><!> <!> <!> <!> <!></div></div> <!> <!> <div class="values svelte-un626g"><div class="svelte-un626g"><!></div> <!></div> <div class="values svelte-un626g"><div class="svelte-un626g"><!> <!></div> <div class="svelte-un626g"><!> <!></div></div> <div class="flex gap-05"><!> <!></div> <!>', 1), Ov = qe('<div class="picture svelte-un626g"><!></div> <!>', 1);
function Nv(e, t) {
  Lt(t, true);
  let a = vv(t, "user", 15), i = ar(), l = Vt(), d = ee(""), n = ee(false), P = ee(""), x = ee(""), T = ee(""), b = rt(() => {
    var _a3;
    return (_a3 = Sh().common()) == null ? void 0 : _a3.map((f) => f);
  }), k = ee("en"), I = ee(""), E = ee(""), V = ee(""), D = ee(""), S = ee(""), h = ee(""), v = ee(false), m = ee(false), _ = ee(false), R = ee(U(Qt())), q = ee(U(jo())), A = ee(U(Uo(() => t.roles.map((f) => ({ name: f.name, selected: false }))))), L = ee(U(Uo(() => t.groups.map((f) => ({ name: f.name, selected: false })))));
  kt(() => {
  ...
  async function s(f, g) {
    ...
    (w(I) || w(E) || w(V) || w(D) || w(S) || w(h)) && (M.user_values = { birthdate: w(I) || void 0, phone: ((_a3 = w(E)) == null ? void 0 : _a3.replaceAll(" ", "")) || void 0, street: w(V) || void 0, zip: w(D) ? Number.parseInt(w(D)) : void 0, city: w(S) || void 0, country: w(h) || void 0 });
  ...
  var o = Jt(), u = Be(o);
  {
    var p = (f) => {
      ...
      Pl(O, { get action() {
        ...
        var we = Z(H, 2), Ve = ue(we), Oe = ue(Ve);
...
let Fv, jl = Bv("", { offsetLine: 1 }), jv, Vl = [], Vv = /* @__PURE__ */ new Map();
const $v = /^\t+/;
function cl(e) {
...
function ir(e, t, a) {
  var _a3;
  let i = Vl;
  if (e && (i = Vv.get(e) ?? Vl), i && ((_a3 = i.at(-1)) == null ? void 0 : _a3.has(t))) return;
...
ne.parseExportDefaultDeclaration = function() {
  ...
  if (this.type === c._function || (e = this.isAsyncFunction())) {
    var t = this.startNode();
    return this.next(), e && this.next(), this.parseFunction(t, qo | Vh, false, e);
...
de.parseMaybeUnary = function(e, t, a, i) {
  ...
  if (this.isContextual("await") && this.canAwait) n = this.parseAwait(i), t = true;
    ...
    P.operator = this.value, P.prefix = true, this.next(), P.argument = this.parseMaybeUnary(null, true, x, i), this.checkExpressionErrors(e, true), x ? this.checkLValSimple(P.argument) : this.strict && P.operator === "delete" && $h(P.argument) ? this.raiseRecoverable(P.start, "Deleting local variable in strict mode") : P.operator === "delete" && Rl(P.argument) ? this.raiseRecoverable(P.start, "Private fields can not be deleted") : t = true, n = this.finishNode(P, x ? "UpdateExpression" : "UnaryExpression");
...
function $h(e) {
  return e.type === "Identifier" || e.type === "ParenthesizedExpression" && $h(e.expression);
}
function Rl(e) {
...
de.parseParenAndDistinguishExpression = function(e, t) {
  ...
  if (this.options.ecmaVersion >= 6) {
    this.next();
    var n = this.start, P = this.startLoc, x = [], T = true, b = false, k = new rl(), I = this.yieldPos, E = this.awaitPos, V;
    for (this.yieldPos = 0, this.awaitPos = 0; this.type !== c.parenR; ) if (T ? T = false : this.expect(c.comma), d && this.afterTrailingComma(c.parenR, true)) {
      ...
      V = this.start, x.push(this.parseParenItem(this.parseRestBinding())), this.type === c.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element");
      break;
    ...
    (!x.length || b) && this.unexpected(this.lastTokStart), V && this.unexpected(V), this.checkExpressionErrors(k, true), this.yieldPos = I || this.yieldPos, this.awaitPos = E || this.awaitPos, x.length > 1 ? (l = this.startNodeAt(n, P), l.expressions = x, this.finishNodeAt(l, "SequenceExpression", D, S)) : l = x[0];
...
var $t = je.prototype, f1 = function(t) {
...
function F1(e) {
  ...
  if (!a) {
    ...
    const T = $1(), b = V1(), k = j1(), I = new RegExp(`^(?:${Object.keys(T).join("|")})$`);
    b.jsxTagStart.updateContext = function() {
      ...
      V === k.tc_oTag && E === c.slash || V === k.tc_cTag ? (this.context.pop(), this.exprAllowed = this.curContext() === k.tc_expr) : this.exprAllowed = true;
...
function W1(e, t, a) {
  ...
  return class extends e {
    ...
    parseDecorators(n) {
      ...
      this.match(i._export) ? n || this.unexpected() : this.canHaveLeadingDecorator() || this.raise(this.start, Vo.UnexpectedLeadingDecorator);
    }
    parseDecorator() {
...
function t0(e) {
  ...
  return function(i) {
    const l = i.acorn || D1, d = F1(l), n = l.tokTypes, P = l.keywordTypes, x = l.isIdentifierStart, T = l.lineBreak, b = l.isNewLine, k = l.tokContexts, I = l.isIdentifierChar, { tokTypes: E, tokContexts: V, keywordsRegExp: D, tokenIsLiteralPropertyName: S, tokenIsTemplate: h, tokenIsTSDeclarationStart: v, tokenIsIdentifier: m, tokenIsKeywordOrIdentifier: _, tokenIsTSTypeOperator: R } = d;
    ...
    class A extends i {
      ...
      readToken(r) {
        if (!this.inType) {
          ...
          if (s === V.tc_expr) return this.jsx_readToken();
          if (s === V.tc_oTag || s === V.tc_cTag) {
            if (x(r)) return this.jsx_readWord();
            if (r == 62) return ++this.pos, this.finishToken(E.jsxTagEnd);
            if ((r === 34 || r === 39) && s == V.tc_oTag) return this.jsx_readString(r);
          }
        ...
        const y = () => {
          if (this.tsIsStartOfStaticBlocks()) {
            ...
            if (o ? (s.computed = false, s.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), s.key.name = o, this.finishNode(s.key, "Identifier")) : this.parseClassElementName(s), this.parsePostMemberNameModifiers(s), this.isClassMethod() || this.ecmaVersion < 13 || this.type === n.parenL || f !== "method" || u || p) {
              const N = !s.static && Kl(s, "constructor"), $ = N && r;
              N && f !== "method" && this.raise(s.key.start, "Constructor can't have get/set modifier"), s.kind = N ? "constructor" : f, this.parseClassMethod(s, u, p, $);
      ...
      parseParenAndDistinguishExpression(r, s) {
        ...
        if (this.ecmaVersion >= 6) {
          ...
          let M = this.start, C = this.startLoc, y = [], O = true, N = false, $ = new cr(), G = this.yieldPos, X = this.awaitPos, Y;
          for (this.yieldPos = 0, this.awaitPos = 0; this.type !== n.parenR; ) if (O ? O = false : this.expect(n.comma), f && this.afterTrailingComma(n.parenR, true)) {
            ...
            break;
          } else y.push(this.parseMaybeAssign(s, $, this.parseParenItem));
          let H = this.lastTokEnd, ae = this.lastTokEndLoc;
          if (this.expect(n.parenR), this.maybeInArrowParameters = g, r && this.shouldParseArrow(y) && this.eat(n.arrow)) return this.checkPatternErrors($, false), this.checkYieldAwaitInDefaultParams(), this.yieldPos = G, this.awaitPos = X, this.parseParenArrowList(o, u, y, s);
          (!y.length || N) && this.unexpected(this.lastTokStart), Y && this.unexpected(Y), this.checkExpressionErrors($, true), this.yieldPos = G || this.yieldPos, this.awaitPos = X || this.awaitPos, y.length > 1 ? (p = this.startNodeAt(M, C), p.expressions = y, this.finishNodeAt(p, "SequenceExpression", H, ae)) : p = y[0];
      ...
      parseSubscript(r, s, o, u, p, f, g) {
        ...
        if (!this.hasPrecedingLineBreak() && this.value === "!" && this.match(n.prefix)) {
          ...
          const $ = this.startNodeAt(s, o);
          return $.expression = r, r = this.finishNode($, "TSNonNullExpression"), r;
        }
        let C = false;
        ...
        if (this.tsMatchLeftRelational() || this.match(n.bitShift)) {
          ...
          const G = this.tsTryParseAndCatch(() => {
            ...
            if (!X) return r;
            if (C && !this.match(n.parenL)) return $ = this.curPosition(), r;
          ...
          if ($ && this.unexpected($), G) return G.type === "TSInstantiationExpression" && (this.match(n.dot) || this.match(n.questionDot) && this.lookaheadCharCode() !== 40) && this.raise(this.start, se.InvalidPropertyAccessAfterInstantiationExpression), r = G, r;
        }
        ...
        if (N || O && this.type !== n.parenL && this.type !== n.backQuote || this.eat(n.dot)) {
          let $ = this.startNodeAt(s, o);
          $.object = r, N ? ($.property = this.parseExpression(), this.expect(n.bracketR)) : this.type === n.privateId && r.type !== "Super" ? $.property = this.parsePrivateIdent() : $.property = this.parseIdent(this.options.allowReserved !== "never"), $.computed = !!N, y && ($.optional = O), r = this.finishNode($, "MemberExpression");
        } else if (!u && this.eat(n.parenL)) {
          const $ = this.maybeInArrowParameters;
          this.maybeInArrowParameters = true;
          ...
          let $ = this.startNodeAt(s, o);
          $.tag = r, $.quasi = this.parseTemplate({ isTagged: true }), r = this.finishNode($, "TaggedTemplateExpression");
        }
        return r;
      }
      parseGetterSetter(r) {
      ...
      parseProperty(r, s) {
        if (!r) {
          ...
          return u.type === "SpreadElement" && o.length && this.raise(u.start, Vo.SpreadElementDecorator), o.length && (u.decorators = o, o = []), u;
        }
      ...
      parseClass(r, s) {
        ...
        try {
          ...
          for (this.expect(n.braceL); this.type !== n.braceR; ) {
            ...
            M.length && (C.decorators = M, this.resetStartLocationFromNode(C, M[0]), M = []), C && (f.body.push(C), C.type === "MethodDefinition" && C.kind === "constructor" && C.value.type === "FunctionExpression" ? (g && this.raiseRecoverable(C.start, "Duplicate constructor in the same class"), g = true, C.decorators && C.decorators.length > 0 && this.raise(C.start, Vo.DecoratorConstructor)) : C.key && C.key.type === "PrivateIdentifier" && G1(p, C) && this.raiseRecoverable(C.key.start, `Identifier '#${C.key.name}' has already been declared`));
          }
          return this.strict = u, this.next(), M.length && this.raise(this.start, Vo.TrailingDecorator), r.body = this.finishNode(f, "ClassBody"), this.exitClassBody(), this.finishNode(r, s ? "ClassDeclaration" : "ClassExpression");
        } finally {
      ...
      parseTypeOnlyImportExportSpecifier(r, s, o) {
        ...
        if (this.isContextual("as")) {
          ...
          if (this.isContextual("as")) {
            const $ = this.parseIdent();
            _(this.type) ? (M = true, f = N, g = s ? this.parseIdent() : this.parseModuleExportName(), C = false) : (g = $, C = false);
      ...
      updateContext(r) {
        ...
        if (s == n.braceL) {
          ...
          o == V.tc_oTag ? this.context.push(k.b_expr) : o == V.tc_expr ? this.context.push(k.b_tmpl) : super.updateContext(r), this.exprAllowed = true;
        } else if (s === n.slash && r === E.jsxTagStart) this.context.length -= 2, this.context.push(V.tc_cTag), this.exprAllowed = false;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var x = [["aria-activedescendant", { type: "id" }], ["aria-atomic", { type: "boolean" }], ["aria-autocomplete", { type: "token", values: ["inline", "list", "both", "none"] }], ["aria-braillelabel", { type: "string" }], ["aria-brailleroledescription", { type: "string" }], ["aria-busy", { type: "boolean" }], ["aria-checked", { type: "tristate" }], ["aria-colcount", { type: "integer" }], ["aria-colindex", { type: "integer" }], ["aria-colspan", { type: "integer" }], ["aria-controls", { type: "idlist" }], ["aria-current", { type: "token", values: ["page", "step", "location", "date", "time", true, false] }], ["aria-describedby", { type: "idlist" }], ["aria-description", { type: "string" }], ["aria-details", { type: "id" }], ["aria-disabled", { type: "boolean" }], ["aria-dropeffect", { type: "tokenlist", values: ["copy", "execute", "link", "move", "none", "popup"] }], ["aria-errormessage", { type: "id" }], ["aria-expanded", { type: "boolean", allowundefined: true }], ["aria-flowto", { type: "idlist" }], ["aria-grabbed", { type: "boolean", allowundefined: true }], ["aria-haspopup", { type: "token", values: [false, true, "menu", "listbox", "tree", "grid", "dialog"] }], ["aria-hidden", { type: "boolean", allowundefined: true }], ["aria-invalid", { type: "token", values: ["grammar", false, "spelling", true] }], ["aria-keyshortcuts", { type: "string" }], ["aria-label", { type: "string" }], ["aria-labelledby", { type: "idlist" }], ["aria-level", { type: "integer" }], ["aria-live", { type: "token", values: ["assertive", "off", "polite"] }], ["aria-modal", { type: "boolean" }], ["aria-multiline", { type: "boolean" }], ["aria-multiselectable", { type: "boolean" }], ["aria-orientation", { type: "token", values: ["vertical", "undefined", "horizontal"] }], ["aria-owns", { type: "idlist" }], ["aria-placeholder", { type: "string" }], ["aria-posinset", { type: "integer" }], ["aria-pressed", { type: "tristate" }], ["aria-readonly", { type: "boolean" }], ["aria-relevant", { type: "tokenlist", values: ["additions", "all", "removals", "text"] }], ["aria-required", { type: "boolean" }], ["aria-roledescription", { type: "string" }], ["aria-rowcount", { type: "integer" }], ["aria-rowindex", { type: "integer" }], ["aria-rowspan", { type: "integer" }], ["aria-selected", { type: "boolean", allowundefined: true }], ["aria-setsize", { type: "integer" }], ["aria-sort", { type: "token", values: ["ascending", "descending", "none", "other"] }], ["aria-valuemax", { type: "number" }], ["aria-valuemin", { type: "number" }], ["aria-valuenow", { type: "number" }], ["aria-valuetext", { type: "string" }]], T = { entries: function() {
    ...
    for (var I = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, E = 0, V = x; E < V.length; E++) {
      var D = a(V[E], 2), S = D[0], h = D[1];
      k.call(I, h, S, x);
    }
  }, get: function(k) {
...
function B0() {
  if (Au) return $r;
  Au = 1, Object.defineProperty($r, "__esModule", { value: true }), $r.default = void 0;
...
function Q0() {
  if (Vu) return ta;
  Vu = 1, Object.defineProperty(ta, "__esModule", { value: true }), ta.default = void 0;
...
function J0() {
  if ($u) return ra;
  $u = 1, Object.defineProperty(ra, "__esModule", { value: true }), ra.default = void 0;
...
function Bb() {
  if (Ac) return $a;
  Ac = 1, Object.defineProperty($a, "__esModule", { value: true }), $a.default = void 0;
...
function Qb() {
  if (Vc) return ti;
  Vc = 1, Object.defineProperty(ti, "__esModule", { value: true }), ti.default = void 0;
...
function Jb() {
  if ($c) return ri;
  $c = 1, Object.defineProperty(ri, "__esModule", { value: true }), ri.default = void 0;
...
function By() {
  if (Ad) return $i;
  Ad = 1, Object.defineProperty($i, "__esModule", { value: true }), $i.default = void 0;
...
function $y() {
  ...
  var e = H(ty()), t = H(ry()), a = H(ay()), i = H(iy()), l = H(sy()), d = H(ny()), n = H(oy()), P = H(ly()), x = H(uy()), T = H(cy()), b = H(dy()), k = H(py()), I = H(fy()), E = H(hy()), V = H(my()), D = H(vy()), S = H(by()), h = H(yy()), v = H(gy()), m = H(Ry()), _ = H(xy()), R = H(_y()), q = H(Cy()), A = H(Py()), L = H(qy()), r = H(Ty()), s = H(Sy()), o = H(Ay()), u = H(wy()), p = H(Ey()), f = H(ky()), g = H(Iy()), M = H(My()), C = H(Ly()), y = H(Oy()), O = H(Ny()), N = H(Dy()), $ = H(By()), G = H(Fy()), X = H(jy()), Y = H(Vy());
  function H(ce) {
    return ce && ce.__esModule ? ce : { default: ce };
  }
  var ae = [["doc-abstract", e.default], ["doc-acknowledgments", t.default], ["doc-afterword", a.default], ["doc-appendix", i.default], ["doc-backlink", l.default], ["doc-biblioentry", d.default], ["doc-bibliography", n.default], ["doc-biblioref", P.default], ["doc-chapter", x.default], ["doc-colophon", T.default], ["doc-conclusion", b.default], ["doc-cover", k.default], ["doc-credit", I.default], ["doc-credits", E.default], ["doc-dedication", V.default], ["doc-endnote", D.default], ["doc-endnotes", S.default], ["doc-epigraph", h.default], ["doc-epilogue", v.default], ["doc-errata", m.default], ["doc-example", _.default], ["doc-footnote", R.default], ["doc-foreword", q.default], ["doc-glossary", A.default], ["doc-glossref", L.default], ["doc-index", r.default], ["doc-introduction", s.default], ["doc-noteref", o.default], ["doc-notice", u.default], ["doc-pagebreak", p.default], ["doc-pagefooter", f.default], ["doc-pageheader", g.default], ["doc-pagelist", M.default], ["doc-part", C.default], ["doc-preface", y.default], ["doc-prologue", O.default], ["doc-pullquote", N.default], ["doc-qna", $.default], ["doc-subtitle", G.default], ["doc-tip", X.default], ["doc-toc", Y.default]];
...
function Ml() {
  ...
  var e = d(P0()), t = d(ey()), a = d($y()), i = d(Wy()), l = d(Io());
  function d(D) {
    return D && D.__esModule ? D : { default: D };
  }
  function n(D, S) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  return hr.default = (0, l.default)(V, V.entries()), hr;
}
var Yi = {}, Bd;
function zy() {
  if (Bd) return Yi;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  for (var T = [], b = t.default.keys(), k = 0; k < b.length; k++) {
    ...
    if (E) for (var V = [].concat(E.baseConcepts, E.relatedConcepts), D = function() {
      var q = V[S];
      if (q.module === "HTML") {
        var A = q.concept;
        if (A) {
...
function sl() {
  if ($d) return Bo;
  $d = 1, Object.defineProperty(Bo, "__esModule", { value: true }), Bo.default = i;
  var e = t(Yy());
  function t(l) {
    return l && l.__esModule ? l : { default: l };
  }
...
function Dg() {
  if (wp) return Vs;
  wp = 1, Object.defineProperty(Vs, "__esModule", { value: true }), Vs.default = void 0;
...
function Bg() {
  if (Ep) return $s;
  Ep = 1, Object.defineProperty($s, "__esModule", { value: true }), $s.default = void 0;
...
function Yg() {
  if ($p) return en;
  $p = 1, Object.defineProperty(en, "__esModule", { value: true }), en.default = void 0;
...
function NR() {
  if (wf) return Vn;
  wf = 1, Object.defineProperty(Vn, "__esModule", { value: true }), Vn.default = void 0;
...
function DR() {
  if (Ef) return $n;
  Ef = 1, Object.defineProperty($n, "__esModule", { value: true }), $n.default = void 0;
...
function XR() {
  if ($f) return eo;
  $f = 1, Object.defineProperty(eo, "__esModule", { value: true }), eo.default = void 0;
  var e = { relatedConcepts: [], type: "structure" }, t = e;
...
function nl() {
  ...
  var e = j(sl()), t = j(Qy()), a = j(Jy()), i = j(Zy()), l = j(eg()), d = j(tg()), n = j(rg()), P = j(ag()), x = j(ig()), T = j(sg()), b = j(ng()), k = j(og()), I = j(lg()), E = j(ug()), V = j(cg()), D = j(dg()), S = j(pg()), h = j(fg()), v = j(hg()), m = j(mg()), _ = j(vg()), R = j(bg()), q = j(yg()), A = j(gg()), L = j(Rg()), r = j(xg()), s = j(_g()), o = j(Cg()), u = j(Pg()), p = j(qg()), f = j(Tg()), g = j(Sg()), M = j(Ag()), C = j(wg()), y = j(Eg()), O = j(kg()), N = j(Ig()), $ = j(Mg()), G = j(Lg()), X = j(Og()), Y = j(Ng()), H = j(Dg()), ae = j(Bg()), ce = j(Fg()), ge = j(jg()), xe = j(Vg()), we = j($g()), Ve = j(Hg()), Oe = j(Ug()), Le = j(Gg()), ze = j(Wg()), Se = j(zg()), ct = j(Kg()), Ue = j(Xg()), gt = j(Yg()), dt = j(Qg()), Rt = j(Jg()), Dt = j(Zg()), St = j(eR()), B = j(tR()), W = j(rR()), K = j(aR()), Q = j(iR()), oe = j(sR()), ie = j(nR()), be = j(oR()), Te = j(lR()), pe = j(uR()), _e2 = j(cR()), He = j(dR()), Ie = j(pR()), Ee = j(fR()), $e = j(hR()), Qe = j(mR()), et = j(vR()), st = j(bR()), pt = j(yR()), At = j(gR()), Ke = j(RR()), wt = j(xR()), J = j(_R()), Ae = j(CR()), he = j(PR()), z = j(qR()), Ge = j(TR()), Ye = j(SR()), Xe = j(AR()), Je = j(wR()), Bt = j(ER()), ym = j(kR()), gm = j(IR()), Rm = j(MR()), xm = j(LR()), _m = j(OR()), Cm = j(NR()), Pm = j(DR()), qm = j(BR()), Tm = j(FR()), Sm = j(jR()), Am = j(VR()), wm = j($R()), Em = j(HR()), km = j(UR()), Im = j(GR()), Mm = j(WR()), Lm = j(zR()), Om = j(KR()), Nm = j(XR()), Dm = j(YR()), Bm = j(QR()), Fm = j(JR()), jm = j(ZR()), Vm = j(ex()), $m = j(tx()), Hm = j(rx()), Um = j(ax()), Gm = j(ix()), Wm = j(sx()), zm = j(nx()), Km = j(ox()), Xm = j(lx()), Ym = j(ux()), Qm = j(cx()), Jm = j(dx()), Zm = j(px());
  function j(Ce) {
    return Ce && Ce.__esModule ? Ce : { default: Ce };
  }
  function ol(Ce, De) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var D = { entries: function() {
    ...
    var m = b.find(function(_) {
      return v.name === _[0].name && V(v.attributes, _[0].attributes);
    });
    return m && m[1];
  }, has: function(v) {
    return !!D.get(v);
...
function Ll() {
  return dh || (dh = 1, function(e, t) {
    (function(a, i) {
      ...
      const D = [];
      function S(o) {
        const { length: u } = o, p = new V(o), f = [], g = [];
        let M = 0;
        for (; p.pos < u; p.pos++) {
          M = x(p, M);
          const C = x(p, 0);
          ...
          const y = x(p, 0), $ = x(p, 0) & 1 ? [M, C, 0, 0, y, x(p, 0)] : [M, C, 0, 0, y];
          let G = D;
          if (b(p, u)) {
            G = [];
            do {
      ...
      function m(o) {
        const { length: u } = o, p = new V(o), f = [], g = [];
        let M = 0, C = 0, y = 0, O = 0, N = 0, $ = 0, G = 0, X = 0;
        do {
          const Y = p.indexOf(";");
          let H = 0;
          for (; p.pos < Y; p.pos++) {
            ...
            if (Oe.isScope = !!xe, ge) {
              ...
              O = x(p, O);
              const Se = Le === O;
              N = x(p, Se ? N : 0), $ = x(p, Se && ze === N ? $ : 0), we = [O, N, $];
            }
            ...
            Oe.bindings = Ve, f.push(Oe), g.push(Oe);
          }
          M++, p.pos = Y + 1;
        } while (p.pos < u);
        return f;
      ...
      function R(o, u, p, f) {
        const g = o[u], { 0: M, 1: C, 2: y, 3: O, isScope: N, callsite: $, bindings: G } = g;
        f[0] < M ? (q(p, f[0], M), f[0] = M, f[1] = 0) : u > 0 && p.write(44), f[1] = T(p, g[1], f[1]);
        const X = (g.length === 6 ? 1 : 0) | ($ ? 2 : 0) | (N ? 4 : 0);
      ...
      function A(o) {
        ...
        do {
          ...
          for (g = 0; p.pos < N; ) {
            let Y;
            g = x(p, g), g < X && (G = false), X = g, b(p, N) ? (M = x(p, M), C = x(p, C), y = x(p, y), b(p, N) ? (O = x(p, O), Y = [g, M, C, y, O]) : Y = [g, M, C, y]) : Y = [g], $.push(Y), p.pos++;
          }
          G || L($), f.push($), p.pos = N + 1;
        } while (p.pos <= u);
        return f;
      }
      function L(o) {
      ...
      function s(o) {
        ...
        for (let C = 0; C < o.length; C++) {
          ...
          for (let N = 0; N < y.length; N++) {
            const $ = y[N];
            N > 0 && u.write(44), O = T(u, $[0], O), $.length !== 1 && (p = T(u, $[1], p), f = T(u, $[2], f), g = T(u, $[3], g), $.length !== 4 && (M = T(u, $[4], M)));
          }
        }
        return u.flush();
      }
...
Ll();
var $o = { exports: {} }, _o = { exports: {} }, Ho = { exports: {} }, _x = Ho.exports, ph;
function Cx() {
  return ph || (ph = 1, function(e, t) {
    (function(a, i) {
      ...
      function D(v, m) {
        S(m, m.type), v.path === "/" ? v.path = m.path : v.path = V(m.path) + v.path;
      }
      function S(v, m) {
...
function vm() {
  return fh || (fh = 1, function(e, t) {
    (function(a, i) {
      ...
      function r(B, W) {
        ...
        for (let Q = 0; Q < B.length; Q++) {
          ...
          for (let ie = 0; ie < oe.length; ie++) {
            ...
            let $e = R(Ie, _e2, L(Ie, _e2, Ee, pe));
            Ee.lastIndex = ++$e, s(Ie, $e, [_e2, Q, be[P]]);
          }
        }
        return K;
      }
      ...
      const y = "`line` must be greater than 0 (lines start at line 1)", O = "`column` must be greater than or equal to 0 (columns start at column 0)", N = -1, $ = 1;
      class G {
        constructor(W, K) {
          ...
          const Ie = d(pe || "", n(K));
          this.resolvedSources = _e2.map(($e) => d($e || "", Ie));
          const { mappings: Ee } = oe;
          typeof Ee == "string" ? (this._encoded = Ee, this._decoded = void 0) : (this._encoded = void 0, this._decoded = V(Ee, Q)), this._decodedMemo = A(), this._bySources = void 0, this._bySourceMemos = void 0;
        }
      }
      function X(B) {
        return B;
      ...
      function ae(B, W, K) {
        ...
        const oe = Q[W], ie = Rt(oe, B._decodedMemo, W, K, $);
      ...
      function ce(B, W) {
        ...
        const be = ie[K], Te = Rt(be, B._decodedMemo, K, Q, oe || $);
      ...
      function we(B, W) {
        ...
        for (let ie = 0; ie < K.length; ie++) {
          ...
          for (let Te = 0; Te < be.length; Te++) {
            ...
            let Ie = null, Ee = null, $e = null, Qe = null;
            pe.length !== 1 && (Ie = oe[pe[1]], Ee = pe[2] + 1, $e = pe[3]), pe.length === 5 && (Qe = Q[pe[4]]), W({ generatedLine: _e2, generatedColumn: He, source: Ie, originalLine: Ee, originalColumn: $e, name: Qe });
          }
        }
      }
      function Ve(B, W) {
      ...
      function St(B, W, K, Q, oe, ie) {
        ...
        const $e = Rt(Ie, Ee, K, Q, oe);
        if ($e === -1) return dt(null, null);
        const Qe = Ie[$e];
        return dt(Qe[I] + 1, Qe[E]);
      }
      a.AnyMap = u, a.GREATEST_LOWER_BOUND = $, a.LEAST_UPPER_BOUND = N, a.TraceMap = G, a.allGeneratedPositionsFor = xe, a.decodedMap = Se, a.decodedMappings = H, a.eachMapping = we, a.encodedMap = ct, a.encodedMappings = Y, a.generatedPositionFor = ge, a.isIgnored = Le, a.originalPositionFor = ce, a.presortedDecodedMap = ze, a.sourceContentFor = Oe, a.traceSegment = ae;
    });
  ...
  return hh || (hh = 1, function(e, t) {
    (function(a, i) {
      ...
      function n(T, b) {
        ...
        const { array: I, _indexes: E } = T, V = I.push(b);
        return E[b] = V - 1;
      }
      function P(T) {
...
function Ax() {
  return mh || (mh = 1, function(e, t) {
    (function(a, i) {
      ...
      function V(C, y, O, N, $, G, X, Y) {
        return L(false, C, y, O, N, $, G, X, Y);
      }
      function D(C, y) {
        return M(false, C, y);
      }
      const S = (C, y, O, N, $, G, X, Y) => L(true, C, y, O, N, $, G, X, Y), h = (C, y) => M(true, C, y);
      function v(C, y, O) {
        const { _sources: N, _sourcesContent: $ } = C, G = i.put(N, y);
        $[G] = O;
      }
      function m(C, y, O = true) {
        const { _sources: N, _sourcesContent: $, _ignoreList: G } = C, X = i.put(N, y);
        X === $.length && ($[X] = null), O ? i.put(G, X) : i.remove(G, X);
      }
      function _(C) {
        const { _mappings: y, _sources: O, _sourcesContent: N, _names: $, _ignoreList: G } = C;
        return u(y), { version: 3, file: C.file || void 0, names: $.array, sourceRoot: C.sourceRoot || void 0, sources: O.array, sourcesContent: N, mappings: y, ignoreList: G.array };
      }
      function R(C) {
        const y = _(C);
      ...
      function A(C) {
        const y = [], { _mappings: O, _sources: N, _names: $ } = C;
        for (let G = 0; G < O.length; G++) {
          const X = O[G];
          for (let Y = 0; Y < X.length; Y++) {
            const H = X[Y], ae = { line: G + 1, column: H[0] };
            let ce, ge, xe;
            H.length !== 1 && (ce = N.array[H[1]], ge = { line: H[2] + 1, column: H[3] }, H.length === 5 && (xe = $.array[H[4]])), y.push({ generated: ae, source: ce, original: ge, name: xe });
          }
        }
        return y;
      }
      function L(C, y, O, N, $, G, X, Y, H) {
        const { _mappings: ae, _sources: ce, _sourcesContent: ge, _names: xe } = y, we = r(ae, O), Ve = s(we, N);
        if (!$) return C && f(we, Ve) ? void 0 : o(we, Ve, [N]);
        const Oe = i.put(ce, $), Le = Y ? i.put(xe, Y) : -1;
        if (Oe === ge.length && (ge[Oe] = H ?? null), !(C && g(we, Ve, Oe, G, X, Le))) return o(we, Ve, Y ? [N, Oe, G, X, Le] : [N, Oe, G, X]);
      }
      function r(C, y) {
      ...
      function g(C, y, O, N, $, G) {
        if (y === 0) return false;
        const X = C[y - 1];
        return X.length === 1 ? false : O === X[1] && N === X[2] && $ === X[3] && G === (X.length === 5 ? X[4] : -1);
      }
      function M(C, y, O) {
        const { generated: N, source: $, original: G, name: X, content: Y } = O;
        return $ ? L(C, y, N.line - 1, N.column, $, G.line - 1, G.column, X, Y) : L(C, y, N.line - 1, N.column, null, null, null, null, null);
      }
      a.GenMapping = I, a.addMapping = D, a.addSegment = V, a.allMappings = A, a.fromMap = q, a.maybeAddMapping = h, a.maybeAddSegment = S, a.setIgnore = m, a.setSourceContent = v, a.toDecodedMap = _, a.toEncodedMap = R, Object.defineProperty(a, "__esModule", { value: true });
    });
...
Did you specify these with the most recent transformation maps first?`);
      ...
      function V(h, v, m, _) {
        const { resolvedSources: R, sourcesContent: q, ignoreList: A } = h, L = _ + 1, r = R.map((s, o) => {
          ...
          if (p) return V(new a.TraceMap(p, f), v, f, L);
...
function Nx(e, t) {
  Lt(t, true);
  let a = ar(), i = Vt(), l = ee(""), d = ee(false), n = ee(U([])), P = ee(U([])), x = ee(U([]));
  xl(() => {
    T();
  }), kt(() => {
    b();
...
var Dx = qe("<p><b> </b></p> <p> </p> <!>", 1), Bx = qe('<div class="desc"><p><b> </b></p> <p> </p> <p> </p></div>'), Fx = qe('<!> <!> <!> <div></div> <p> </p> <div class="flex gap-05"><!> <!> <!></div>', 1), jx = qe("<div></div> <!> <!>", 1), Vx = qe('<div class="err"> </div>'), $x = qe("<!> <!>", 1);
function Hx(e, t) {
  Lt(t, true);
  const a = "min(20rem, calc(100dvw - .5rem))";
  let i = ar(), l = Vt(), d = ee(false), n = ee(""), P = ee(false), x = ee(void 0), T = ee(false), b = ee(""), k = ee(""), I = rt(() => {
    var _a3;
    return w(b).length > (((_a3 = w(x)) == null ? void 0 : _a3.length_min) || 8) && w(b) === w(k);
  }), E = ee(void 0), V = ee(void 0);
  xl(async () => {
    var _a3;
  ...
  function h() {
    ...
    F(b, U(L)), F(k, U(L)), requestAnimationFrame(() => {
      var _a3, _b2;
      (_a3 = w(E)) == null ? void 0 : _a3(), (_b2 = w(V)) == null ? void 0 : _b2();
    });
  }
  var v = $x(), m = Be(v);
  {
    ...
    }, R = (L, r) => {
      {
        var s = (u) => {
          ...
          Pl(C, { get action() {
            ...
            le(ge);
            var we = Z(ge, 2), Ve = ue(we);
            Et(Ve, { onclick: D, get isLoading() {
              return w(d);
            }, children: (Se, ct) => {
              We();
              var Ue = Fe();
            ...
            le(we), me(() => fe(xe, l.users.selfServiceDesc)), te(O, $);
...
function Kx(e, t) {
  ...
  async function n(E) {
    var _a3;
    let V = w(l).length === 1, D = await Cl(`/auth/v1/users/${t.user.id}/webauthn/delete/${E}`);
    D.status === 200 ? (await d(), V && t.onSave()) : F(i, U(((_a3 = D.error) == null ? void 0 : _a3.message) || "Error"));
  }
  var P = zx(), x = Be(P);
  {
    var T = (E) => {
      var V = Ux(), D = ue(V, true);
      le(V), me(() => fe(D, a.users.noMfaKeys)), te(E, V);
    }, b = (E) => {
      var V = Gx(), D = Be(V), S = ue(D, true);
      le(D);
      var h = Z(D, 2), v = ue(h);
      ...
      }), le(m), me(() => fe(S, a.users.mfaDelete1)), te(E, V);
    };
    ye(x, (E) => {
  ...
  {
    var I = (E) => {
      var V = Wx(), D = ue(V, true);
      le(V), me(() => fe(D, w(i))), te(E, V);
    };
    ye(k, (E) => {
      w(i) && E(I);
    });
...
function e_(e, t) {
  ...
  Et(T, { level: -1, onclick: d, children: (I, E) => {
    We();
    var V = Fe();
    me(() => fe(V, a.common.delete)), te(I, V);
  }, $$slots: { default: true } });
  var b = Z(T, 2);
  {
    var k = (I) => {
      var E = Jx(), V = ue(E, true);
      le(E), me(() => fe(V, w(l))), te(I, E);
    };
    ye(b, (I) => {
      w(l) && I(k);
    });
...
function Y_(e, t) {
  ...
  const a = (g, M = nv) => {
    ...
    dv(g, { onclick: () => x.set(M().id), get selected() {
      ...
      Ah(G, { get fallbackCharacters() {
        ...
        return M().picture_id;
      }, size: "small", disableUpload: true }), le($);
      var Y = Z($, 2), H = ue(Y), ae = ue(H, true);
      le(H);
  ...
  let i = ee(void 0), l = ee(""), d = ee(U([])), n = ee(U([])), P = ee(U([])), x = cv("uid"), T = ee(void 0), b = ee(U([])), k = ee(U([])), I = ee(false), E = ee(void 0), V = ee(U(Cv)), D = ee(false), S = U(["E-Mail", "ID"]), h = ee(U(S[0])), v = ee(""), m = U(["E-Mail", "ID", "Created", "Last Login"]);
  xl(() => {
    R("page_size=" + w(V)), q(), A();
  }), kt(() => {
    var _a3;
    ...
    w(I) ? g.length < 3 ? w(D) && (R("page_size=" + w(V)), F(D, false)) : _(g) : g ? w(h) === S[0] ? F(n, U(w(d).filter((M) => {
      var _a3;
  ...
  function r(g, M) {
    ...
    g === m[0] ? w(d).sort((y, O) => C ? y.email.localeCompare(O.email) : O.email.localeCompare(y.email)) : g === m[1] ? w(d).sort((y, O) => C ? y.id.localeCompare(O.id) : O.id.localeCompare(y.id)) : g === m[2] ? w(d).sort((y, O) => C ? y.created_at - O.created_at : O.created_at - y.created_at) : g === m[3] && w(d).sort((y, O) => {
      let N = y.last_login || 9999999999, $ = y.last_login || 9999999999;
      return C ? N - $ : $ - N;
    });
  }
  async function s(g) {
