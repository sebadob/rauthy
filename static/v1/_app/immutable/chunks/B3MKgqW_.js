...
window.fetch = (e, t) => ((e instanceof Request ? e.method : (t == null ? void 0 : t.method) || "GET") !== "GET" && z.delete(Ee(e)), St(e, t));
...
function Et(e, t) {
  ...
  if (r == null ? void 0 : r.textContent) {
    ...
    return i && z.set(n, { body: a, init: s, ttl: 1e3 * Number(i) }), r.getAttribute("data-b64") !== null && (a = At(a)), Promise.resolve(new Response(a, s));
  }
  return window.fetch(e, t);
}
function Rt(e, t, n) {
  if (z.size > 0) {
    const r = Ee(e, n), a = z.get(r);
    if (a) {
...
const U = ((_a = globalThis.__sveltekit_z4aeih) == null ? void 0 : _a.base) ?? "/auth/v1", Ct = ((_b = globalThis.__sveltekit_z4aeih) == null ? void 0 : _b.assets) ?? U, Ot = "1743150748516", We = "sveltekit:snapshot", Ye = "sveltekit:scroll", Je = "sveltekit:states", Nt = "sveltekit:pageurl", B = "sveltekit:history", W = "sveltekit:navigation", j = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 }, Z = location.origin;
function Xe(e) {
...
Xt ? (S = { data: {}, form: null, error: null, params: {}, route: { id: null }, state: {}, status: -1, url: new URL("https://example.com") }, Y = { current: null }, ye = { current: false }) : (S = new (_c = class {
  constructor() {
...
}, _e2 = new WeakMap(), _t2 = new WeakMap(), _n2 = new WeakMap(), _r = new WeakMap(), _a2 = new WeakMap(), _o = new WeakMap(), _s = new WeakMap(), _i = new WeakMap(), _c)(), Y = new (_d = class {
  constructor() {
...
const nn = /* @__PURE__ */ new Set(["icon", "shortcut icon", "apple-touch-icon"]), D = Ke(Ye) ?? {}, J = Ke(We) ?? {}, N = { url: Ve({}), page: Ve({}), navigating: Se(null), updated: jt() };
function Le(e) {
  D[e] = Re();
}
function rn(e, t) {
...
async function Sn(e, t, n) {
  var _a3, _b2, _c2, _d2;
  document.URL !== location.href && (location.href = location.href), v = e, await ((_b2 = (_a3 = e.hooks).init) == null ? void 0 : _b2.call(_a3)), Te = Pt(e), C = document.documentElement, Ae = t, ke = e.nodes[0], ae = e.nodes[1], ke(), ae(), k = (_c2 = history.state) == null ? void 0 : _c2[B], I = (_d2 = history.state) == null ? void 0 : _d2[W], k || (k = I = Date.now(), history.replaceState({ ...history.state, [B]: k, [W]: I }, ""));
  const r = D[k];
...
function ce({ url: e, params: t, branch: n, status: r, error: a, route: s, form: i }) {
  ...
  const c = { type: "loaded", state: { url: e, params: t, branch: n, error: a, route: s }, props: { constructors: Kt(n).map((f) => f.node.component), page: je(S) } };
...
async function ft({ id: e, invalidating: t, url: n, params: r, route: a, preload: s }) {
  ...
  const m = l.map((g, w) => {
    var _a3;
    const b = y.branch[w], A = !!(g == null ? void 0 : g[0]) && ((b == null ? void 0 : b.loader) !== g[1] || ze(p, d, h, f, (_a3 = b.server) == null ? void 0 : _a3.uses, r));
    return A && (p = true), A;
  });
  if (m.some(Boolean)) {
    try {
      ...
      return K.has(s) ? He({ error: w, url: n, params: r, route: a }) : de({ status: re(g), error: w, url: n, route: a });
    }
  ...
  const E = l.map(async (g, w) => {
    ...
    if ((!A || A.type === "skip") && g[1] === (b == null ? void 0 : b.loader) && !ze(R, d, h, f, (_a3 = b.universal) == null ? void 0 : _a3.uses, r)) return b;
  ...
  for (let g = 0; g < l.length; g += 1) if (l[g]) try {
    ...
    if (K.has(s)) return He({ error: await q(w, { params: r, url: n, route: { id: a.id } }), url: n, params: r, route: a });
    let b = re(w), A;
...
async function te({ type: e, url: t, popped: n, keepfocus: r, noscroll: a, replace_state: s, state: i = {}, redirect_count: o = 0, nav_token: c = {}, accept: l = qe, block: u = qe }) {
  ...
  const p = k, m = I;
  l(), X = true, ie && N.navigating.set(Y.current = f.navigation);
  let _ = d && await ft(d);
  if (!_) {
  ...
  if (on(), Le(p), st(m), _.props.page.url.pathname !== t.pathname && (t.pathname = _.props.page.url.pathname), i = n ? n.state : i, !n) {
    const g = s ? 0 : 1, w = { [B]: k += g, [W]: I += g, [Je]: i };
  ...
  !r && !L && mn(), Me = true, _.props.page && Object.assign(S, _.props.page), X = false, e === "popstate" && it(I), f.fulfil(void 0), H.forEach((g) => g(f.navigation)), N.navigating.set(Y.current = null);
}
...
function gn() {
  ...
  history.scrollRestoration = "manual", addEventListener("beforeunload", (t) => {
    ...
    if ((_a4 = t.state) == null ? void 0 : _a4[B]) {
      const n = t.state[B];
      if ($ = {}, n === k) return;
      const r = D[n], a = t.state[Je] ?? {}, s = new URL(t.state[Nt] ?? location.href), i = t.state[W], o = y.url ? me(location) === me(y.url) : false;
      if (i === I && (at || o)) {
    ...
    G && (G = false, history.replaceState({ ...history.state, [B]: ++k, [W]: I }, "", location.href));
  });
...
async function ht(e, t) {
  var _a3;
  const n = new URL(e);
  n.pathname = tn(e.pathname), e.pathname.endsWith("/") && n.searchParams.append(Yt, "1"), n.searchParams.append(Wt, t.map((s) => s ? "1" : "0").join(""));
  ...
  return new Promise(async (s) => {
    ...
    function l(h) {
      return zt(h, { ...v.decoders, Promise: (d) => new Promise((f, p) => {
