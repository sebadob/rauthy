...
const U = ((_a = globalThis.__sveltekit_1ku7qpf) == null ? void 0 : _a.base) ?? "/auth/v1", Ct = ((_b = globalThis.__sveltekit_1ku7qpf) == null ? void 0 : _b.assets) ?? U, Ot = "1741689659866", Ye = "sveltekit:snapshot", ze = "sveltekit:scroll", Je = "sveltekit:states", Nt = "sveltekit:pageurl", V = "sveltekit:history", Y = "sveltekit:navigation", j = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 }, Z = location.origin;
function Xe(e) {
...
async function ft({ id: e, invalidating: t, url: n, params: r, route: a, preload: s }) {
  ...
  const m = l.map((g, w) => {
    var _a3;
    const b = y.branch[w], A = !!(g == null ? void 0 : g[0]) && ((b == null ? void 0 : b.loader) !== g[1] || Ke(p, d, h, f, (_a3 = b.server) == null ? void 0 : _a3.uses, r));
    return A && (p = true), A;
  });
  if (m.some(Boolean)) {
    try {
      ...
      return W.has(s) ? He({ error: w, url: n, params: r, route: a }) : de({ status: re(g), error: w, url: n, route: a });
    }
  ...
  for (let g = 0; g < l.length; g += 1) if (l[g]) try {
    ...
    if (W.has(s)) return He({ error: await B(w, { params: r, url: n, route: { id: a.id } }), url: n, params: r, route: a });
    let b = re(w), A;
...
async function te({ type: e, url: t, popped: n, keepfocus: r, noscroll: a, replace_state: s, state: i = {}, redirect_count: o = 0, nav_token: c = {}, accept: l = Be, block: u = Be }) {
  ...
  if (on(), Le(p), st(m), _.props.page.url.pathname !== t.pathname && (t.pathname = _.props.page.url.pathname), i = n ? n.state : i, !n) {
    const g = s ? 0 : 1, w = { [V]: k += g, [Y]: I += g, [Je]: i };
