import { t as k, a as i, d as pe, n as $e, e as J } from "./DLBGyKVC.js";
import { j as e, k as O, l as p, p as ne, aa as ie, a9 as fe, c as r, r as a, a as de, f as le, s as b, t as h, a8 as Q, P as Ue } from "./CmQi0fbH.js";
import { e as me, s as w, b as De } from "./BjaYyaa_.js";
import { i as K } from "./C6bK2EJJ.js";
import { s as E, a as re, b as Te } from "./DOlUUCkJ.js";
import { a as Ce } from "./B3JAWFL5.js";
import { p as W } from "./B_ggA-0N.js";
import { p as Y } from "./DNJm3-SG.js";
import { I as Ee } from "./CHCNH3ik.js";
import { u as ce } from "./DGTOa5g8.js";
import { i as Ne, g as Fe, C as ze, l as ae } from "./B21bTIl7.js";
import { I as he } from "./Dth7WIu-.js";
import { B as ve } from "./DPLO-ozG.js";
import { f as be, c as ge, d as Ae } from "./BO1A6s0c.js";
import { T as Be } from "./ibGTLHQD.js";
import { e as Se } from "./YQCw2eEa.js";
import { I as Le } from "./DwPr_s7h.js";
import { E as Me } from "./BWK4fHb9.js";
import { g as Re } from "./gfDO7tLr.js";
import { L as te } from "./gwKtuDud.js";
let _e = O(void 0);
function je() {
    ...
    var U = (c) => {
      ...
      var xe = b(v, 2);
      {
        var ke = (j) => {
          ...
          ve(ue, { invisible: true, onclick: N, children: (Ie, vt) => {
            var oe = Ge(), Pe = r(oe);
      ...
      h(() => {
        A = re(v, "", A, { "background-color": e(V), width: e(C) }), E(D, "aria-disabled", e(P)), E(D, "data-show", !e(P) && e(I)), B = re(D, "", B, { width: e(C) }), G.disabled = e(P), E(G, "aria-disabled", e(P));
      }), me("mouseenter", v, Z), me("mouseleave", v, X), Ce(G, () => e(T), (j) => p(T, j)), i(c, u);
    }, z = (c) => {
      var u = Je();
      let v;
      var A = r(u);
      o(A), a(u), h(() => v = re(u, "", v, { "background-color": e(V), width: e(C), height: e(C) })), i(c, u);
    };
    K($, (c) => {
      var _a;
...
function Ct(S, t) {
  ...
  a(q);
  var X = b(q, 2), n = r(X, true);
  a(X), a(R);
  var N = b(R, 2);
  {
    var l = (d) => {
      var $ = Ze(), U = b(r($), 2), z = r(U);
      ve(z, { level: -3, onclick: () => t.onDelete(t.passkey.name), children: (c, u) => {
        Q();
        var v = J();
  ...
  a(s), h((d, $) => {
    w(L, o.mfa.passkeyName), w(x, t.passkey.name), w(T, o.mfa.registerd), w(C, d), w(Z, o.mfa.lastUsed), w(n, $);
...
function it(S, t) {
  ...
  Me(S, { summary: (x) => {
    ...
    var T = b(P, 2);
    {
      var V = (n) => {
        var N = rt(), l = r(N);
        ve(l, { onclick: f, children: (d, $) => {
          Q();
          var U = J();
          h(() => w(U, s.common.save)), i(d, U);
        }, $$slots: { default: true } }), a(N), i(n, N);
      };
      K(T, (n) => {
        e(y) !== o().name && n(V);
      });
    ...
    te(R, { get label() {
      ...
      Q();
      var l = J();
      h((d) => w(l, d), [() => ae(o().access_exp)]), i(n, l);
    }, $$slots: { default: true } });
    var q = b(R, 2);
    {
      var Z = (n) => {
