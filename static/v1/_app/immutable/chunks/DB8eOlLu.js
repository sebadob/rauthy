import { t as c, a as l, d as D } from "./DLBGyKVC.js";
import { l as f, j as h, k as _, p as I, aa as M, t as L, a as S, f as y, c as B, r as T } from "./CmQi0fbH.js";
import { i as j } from "./C6bK2EJJ.js";
import { b as C } from "./DOlUUCkJ.js";
import { u as z } from "./DGTOa5g8.js";
import { B as A } from "./DPLO-ozG.js";
import { p as P } from "./B_ggA-0N.js";
let i = _(void 0);
function V() {
  return { isDark() {
    return h(i);
...
function R(n, u) {
  ...
  M(() => {
    ...
    if (e.isDark() === void 0) {
      const m = (_c = window == null ? void 0 : window.localStorage) == null ? void 0 : _c.getItem(o);
      if (m) {
        let r = m === "true";
        e.isDark() === t && localStorage.removeItem(o), e.setIsDark(r);
      } else e.setIsDark(t);
    ...
    t === e.isDark() ? localStorage.removeItem(o) : localStorage.setItem(o, "true");
  });
  function k() {
    e.toggle();
  }
  ...
  A(p, { get ariaLabel() {
    ...
    l(t, r);
  }, $$slots: { default: true } }), T(a), L((t) => v = C(a, 1, "container svelte-m6xenu", null, v, t), [() => ({ absolute: u.absolute })]), l(n, a), S();
}
export {
  R as T,
  V as u
