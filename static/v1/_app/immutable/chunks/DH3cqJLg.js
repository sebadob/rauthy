...
import { ab as _e, aK as _t, a6 as $e, k as T, j as x, l as P, av as mt } from "./Ck6jKiur.js";
const F = [];
function Se(e, t = _e) {
  let n = null;
...
const U = ((_a = globalThis.__sveltekit_1fpybfc) == null ? void 0 : _a.base) ?? "/auth/v1", Ct = ((_b = globalThis.__sveltekit_1fpybfc) == null ? void 0 : _b.assets) ?? U, Ot = "1741853818818", Ye = "sveltekit:snapshot", ze = "sveltekit:scroll", Je = "sveltekit:states", Nt = "sveltekit:pageurl", B = "sveltekit:history", Y = "sveltekit:navigation", j = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 }, Z = location.origin;
function Xe(e) {
...
async function ft({ id: e, invalidating: t, url: n, params: r, route: a, preload: s }) {
  ...
  for (let g = 0; g < l.length; g += 1) if (l[g]) try {
    ...
    if (W.has(s)) return He({ error: await q(y, { params: r, url: n, route: { id: a.id } }), url: n, params: r, route: a });
    let b = re(y), A;
...
async function te({ type: e, url: t, popped: n, keepfocus: r, noscroll: a, replace_state: s, state: i = {}, redirect_count: o = 0, nav_token: c = {}, accept: l = qe, block: u = qe }) {
  ...
  if (on(), Le(p), st(m), _.props.page.url.pathname !== t.pathname && (t.pathname = _.props.page.url.pathname), i = n ? n.state : i, !n) {
    const g = s ? 0 : 1, y = { [B]: k += g, [Y]: I += g, [Je]: i };
