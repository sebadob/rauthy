...
import { ab as _e, aK as _t, a6 as $e, k as T, j as x, l as P, av as mt } from "./CmQi0fbH.js";
const F = [];
function Se(e, t = _e) {
  let n = null;
...
const U = ((_a = globalThis.__sveltekit_11gkuwo) == null ? void 0 : _a.base) ?? "/auth/v1", Ct = ((_b = globalThis.__sveltekit_11gkuwo) == null ? void 0 : _b.assets) ?? U, Ot = "1742372864717", Ye = "sveltekit:snapshot", ze = "sveltekit:scroll", Je = "sveltekit:states", Nt = "sveltekit:pageurl", B = "sveltekit:history", Y = "sveltekit:navigation", j = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 }, Z = location.origin;
function Xe(e) {
...
async function ft({ id: e, invalidating: t, url: n, params: r, route: a, preload: s }) {
  ...
  for (let g = 0; g < l.length; g += 1) if (l[g]) try {
    ...
    if (W.has(s)) return He({ error: await q(w, { params: r, url: n, route: { id: a.id } }), url: n, params: r, route: a });
    let b = re(w), A;
