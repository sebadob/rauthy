import { t as T, a as b, d as q, n as $ } from "./CWf9OOFK.js";
import { p as ee, ab as G, t as j, a as te, s as F, c as y, j as t, k as z, f as X, r as w, l as m, aa as ae } from "./nlANaGLT.js";
import { e as ne, d as ie, s as re } from "./BmMHVVX3.js";
import { i as V } from "./DOjUa9u5.js";
import { e as le, i as se } from "./B6azywu7.js";
import { s as l, r as de, a as ce } from "./CZv_AhHu.js";
import { b as ve } from "./DHRD3bu9.js";
import { p as K } from "./5u5qd9TD.js";
import { b as oe } from "./CzqnnvDH.js";
import { p as s } from "./uWmgYd3Z.js";
import { s as Z } from "./BgMuVWsk.js";
import { B as J } from "./BEQMYyDu.js";
import { g as Q } from "./B21bTIl7.js";
import { u as ue } from "./Bb8ybDgy.js";
import { u as he } from "./DwvS5LQk.js";
...
function me(h, e) {
  ...
  function p(i) {
    if (i.stopPropagation(), a() && t(n)) if (e.absolute) t(n).style.top = o(), t(n).style.left = v();
      ...
      t(n).style.top = `calc(${c.bottom + window.scrollY}px + ${o()})`, t(n).style.left = `calc(${c.left + window.scrollX}px + ${v()})`;
    }
  ...
  function H(i) {
    var _a;
    let c = i.newState;
    m(D, c === "open"), (_a = e.onToggle) == null ? void 0 : _a.call(e, c);
  }
  var A = ge(), O = y(A);
  J(O, { get role() {
    return d();
...
function _e(h, e) {
  ...
  l(o, "stroke-width", 2), j(() => {
    l(o, "stroke", v()), l(o, "width", d()), l(o, "opacity", a());
  }), b(h, o);
}
...
function Te(h, e) {
  ee(e, true);
  let a = he(), d = ue(), v = s(e, "id", 19, Q), o = s(e, "value", 15, ""), C = s(e, "placeholder", 19, () => d.common.search), x = s(e, "option", 15), S = s(e, "focus", 15), n = s(e, "width", 3, "100%");
  const D = Q();
  ...
  var r = F(E, 2);
  de(r), r.__click = [Le], r.__keydown = [ye, H, e, o], oe(r, (f) => m(p, f), () => t(p));
  var I = F(r, 2);
  {
    var i = (f) => {
      var u = Be();
  ...
  w(O), j(() => {
    L = ce(O, "", L, { border: e.borderless ? void 0 : "1px solid hsl(var(--bg-high))", width: n() }), l(r, "id", v()), l(r, "list", t(P)), l(r, "aria-label", e.ariaLabel || d.common.search), l(r, "pattern", e.pattern), l(r, "placeholder", C());
  }), ne("focus", r, () => {
    var _a;
...
function Se(h, e) {
  ...
  var o = Ce();
  l(o, "stroke-width", 2), j(() => {
    l(o, "width", d()), l(o, "color", v()), l(o, "opacity", a());
  }), b(h, o);
}
...
function Ee(h, e) {
  ee(e, true);
  let a = s(e, "ref", 15), d = s(e, "options", 19, () => []), v = s(e, "value", 15), o = s(e, "borderless", 3, false), C = s(e, "withSearch", 3, false), x = z(void 0), S = z(void 0), n = z(K(C() ? -1 : 0)), D = z(void 0), p = z(""), P = ae(() => {
    if (!C()) return d();
    if (typeof v() == "string") return d().filter((r) => r.toLowerCase().includes(t(p).toLowerCase()));
  ...
  function O(_) {
    var _a;
    _ === "open" && (C() ? (m(n, -1), (_a = t(D)) == null ? void 0 : _a()) : (m(n, K(d().findIndex((r) => r === v()) || 0)), A()));
  }
  function L() {
  ...
  me(h, { get ariaLabel() {
    ...
    var I = Ue(), i = y(I), c = y(i, true);
    w(i);
    var k = F(i, 2);
    Se(k, { width: ".8rem" }), w(I), j(() => {
      l(I, "data-border", !o()), l(i, "title", e.ariaLabel), re(c, v());
    }), b(r, I);
  }, children: (r, I) => {
    var i = Ae(), c = X(i);
    c.__keydown = [Oe, L, n, E, P];
    let k;
    var M = y(c);
    {
      var N = (u) => {
    ...
    }), w(R), oe(R, (u) => m(x, u), () => t(x)), w(c);
    var f = F(c, 2);
    de(f), j(() => {
      k = ce(c, "", k, { "max-height": e.maxHeight }), l(f, "name", e.name);
    }), ve(f, v), b(r, i);
