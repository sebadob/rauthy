...
const U = ((_a = globalThis.__sveltekit_1kynnh6) == null ? void 0 : _a.base) ?? "/auth/v1", Ct = ((_b = globalThis.__sveltekit_1kynnh6) == null ? void 0 : _b.assets) ?? U, Ot = "1744358165647", Ye = "sveltekit:snapshot", ze = "sveltekit:scroll", Je = "sveltekit:states", Nt = "sveltekit:pageurl", B = "sveltekit:history", Y = "sveltekit:navigation", j = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 }, Z = location.origin;
function Xe(e) {
...
async function ft({ id: e, invalidating: t, url: n, params: r, route: a, preload: s }) {
  ...
  const m = l.map((g, y) => {
    var _a3;
    const b = w.branch[y], A = !!(g == null ? void 0 : g[0]) && ((b == null ? void 0 : b.loader) !== g[1] || He(p, d, h, f, (_a3 = b.server) == null ? void 0 : _a3.uses, r));
    return A && (p = true), A;
  });
  if (m.some(Boolean)) {
    try {
      ...
      return W.has(s) ? Ke({ error: y, url: n, params: r, route: a }) : de({ status: re(g), error: y, url: n, route: a });
    }
