...
import { b as qh, d as Rl, f as Nt, c as xl } from "./DYtiVhoA.js";
import { O as lv } from "./wXCWlxMM.js";
import { P as Dl } from "./CykF7HZG.js";
import { N as uv } from "./CUuTpoTi.js";
import { B as cv } from "./dWvWuq1E.js";
import { u as dv } from "./BpfzNsA6.js";
import { N as pv } from "./D-L0o8jR.js";
import { C as fv } from "./BnPoFdx3.js";
import { I as pt } from "./CeeD0cV_.js";
import { b as Uo, k as hv, l as jl, m as mv } from "./BRCxk8by.js";
import { F as _l } from "./Gcs0S4Fz.js";
import { u as Yt } from "./BQ1-pLIs.js";
import { u as Dt } from "./D8mHI_K9.js";
import { O as Th } from "./BPVdf4Rb.js";
import { n as Sh, l as nl, A as vv } from "./B8wC3kJv.js";
import { I as jo } from "./DTR8xafZ.js";
import { I as hl } from "./CxCmFdor.js";
import { f as zt, a as Bo, b as wh } from "./DswDW5U8.js";
import { S as Go } from "./Bbu1Qkv4.js";
...
import { P as Rv } from "./h7VULPdI.js";
import { I as Bl } from "./D6E4lNPv.js";
import { h as xv } from "./i8Xqpu09.js";
import { U as _v, D as Cv } from "./BsBu3wR9.js";
import { P as Pv, f as qv, a as Tv } from "./D0cGZoiU.js";
var Sv = Me("<div><!></div>"), wv = Me('<div class="err"> </div>'), Av = Me("<!> <!> <!> <!> <!> <!> <!> <!> <div></div> <!> <!>", 1), Ev = Me('<div class="container svelte-x7a3kj"><!></div>');
function kv(e, t) {
  It(t, true);
  let i = Yt(), s = Dt(), l = ie(void 0), p = ie(""), m = ie(""), w = ie(""), _ = ie(""), o = ie("en"), b = ie(W($o(() => t.roles.map((h) => ({ name: h.name, selected: false }))))), O = ie(W($o(() => t.groups.map((h) => ({ name: h.name, selected: false }))))), L = ie(false), B = ie(W(zt())), G = ie(W(Bo()));
  At(() => {
  ...
  async function F(h, g) {
    var _a3, _b2;
    $(p, "");
    let S = { email: k(m), given_name: k(w), family_name: k(_) || void 0, language: k(o), groups: k(O).filter((x) => x.selected).map((x) => x.name), roles: k(b).filter((x) => x.selected).map((x) => x.name), user_expires: wh(k(B), k(G)) };
...
function Ov(e, t) {
  It(t, true);
  let i = yv(t, "user", 15), s = Yt(), l = Dt(), p = ie(""), m = ie(false), w = ie(""), _ = ie(""), o = ie(""), b = ie("en"), O = ie(""), L = ie(""), B = ie(""), G = ie(""), F = ie(""), R = ie(""), v = ie(false), h = ie(false), g = ie(false), S = ie(W(zt())), C = ie(W(Bo())), x = ie(W($o(() => t.roles.map((N) => ({ name: N.name, selected: false }))))), E = ie(W($o(() => t.groups.map((N) => ({ name: N.name, selected: false })))));
  At(() => {
    var _a3, _b2, _c2, _d2, _e3, _f2, _g2;
    if (i()) {
      if ($(w, W(i().email)), $(_, W(i().given_name)), $(o, W(i().family_name || "")), $(b, W(i().language)), $(O, W(((_a3 = i().user_values) == null ? void 0 : _a3.birthdate) || "")), $(L, W(((_b2 = i().user_values) == null ? void 0 : _b2.phone) || "")), $(B, W(((_c2 = i().user_values) == null ? void 0 : _c2.street) || "")), $(G, W(((_e3 = (_d2 = i().user_values) == null ? void 0 : _d2.zip) == null ? void 0 : _e3.toString()) || "")), $(F, W(((_f2 = i().user_values) == null ? void 0 : _f2.city) || "")), $(R, W(((_g2 = i().user_values) == null ? void 0 : _g2.country) || "")), $(v, W(i().enabled)), $(h, W(i().email_verified)), i().user_expires) {
  ...
  async function D(N, I) {
    ...
    (k(O) || k(L) || k(B) || k(G) || k(F) || k(R)) && (M.user_values = { birthdate: k(O) || void 0, phone: ((_a3 = k(L)) == null ? void 0 : _a3.replaceAll(" ", "")) || void 0, street: k(B) || void 0, zip: k(G) ? Number.parseInt(k(G)) : void 0, city: k(F) || void 0, country: k(R) || void 0 });
...
function Dv(e, t = {}) {
  ...
  const p = e.split(`
`).map((_, o) => {
    const b = l + _.length + 1, O = { start: l, end: b, line: o };
    return l = b, O;
  });
  let m = 0;
  function w(_, o) {
...
`), l = Math.max(0, t - 2), p = Math.min(t + 3, s.length), m = String(p + 1).length;
  return s.slice(l, p).map((w, _) => {
    ...
    if (o) {
      const O = " ".repeat(m + 2 + ol(w.slice(0, i)).length) + "^";
      return `${b}: ${ol(w)}
${O}`;
    }
    return `${b}: ${ol(w)}`;
...
ye.parseExprOp = function(e, t, i, s, l) {
  ...
  if (p != null && (!l || this.type !== d._in) && p > s) {
    ...
    var _ = this.value;
    this.next();
    var o = this.start, b = this.startLoc, O = this.parseExprOp(this.parseMaybeUnary(null, false, false, l), o, b, p, l), L = this.buildBinary(t, i, e, O, _, m || w);
    return (m && this.type === d.coalesce || w && (this.type === d.logicalOR || this.type === d.logicalAND)) && this.raiseRecoverable(this.start, "Logical expressions and coalesce expressions cannot be mixed. Wrap either by parentheses"), this.parseExprOp(L, t, i, s, l);
  }
  return e;
};
...
ye.parseSubscript = function(e, t, i, s, l, p, m) {
  ...
  if (o || _ && this.type !== d.parenL && this.type !== d.backQuote || this.eat(d.dot)) {
    ...
    var F = this.parseExprList(d.parenR, this.options.ecmaVersion >= 8, false, O);
...
ye.parseExprAtom = function(e, t, i) {
  ...
  switch (this.type) {
    ...
    case d.parenL:
      var b = this.start, O = this.parseParenAndDistinguishExpression(l, t);
      return e && (e.parenthesizedAssign < 0 && !this.isSimpleAssignTarget(O) && (e.parenthesizedAssign = b), e.parenthesizedBind < 0 && (e.parenthesizedBind = b)), O;
    case d.bracketL:
...
ye.parseParenAndDistinguishExpression = function(e, t) {
  ...
  if (this.options.ecmaVersion >= 6) {
    this.next();
    var m = this.start, w = this.startLoc, _ = [], o = true, b = false, O = new Zo(), L = this.yieldPos, B = this.awaitPos, G;
    for (this.yieldPos = 0, this.awaitPos = 0; this.type !== d.parenR; ) if (o ? o = false : this.expect(d.comma), p && this.afterTrailingComma(d.parenR, true)) {
      ...
      break;
    } else _.push(this.parseMaybeAssign(false, O, this.parseParenItem));
    var F = this.lastTokEnd, R = this.lastTokEndLoc;
    if (this.expect(d.parenR), e && this.shouldParseArrow(_) && this.eat(d.arrow)) return this.checkPatternErrors(O, false), this.checkYieldAwaitInDefaultParams(), this.yieldPos = L, this.awaitPos = B, this.parseParenArrowList(i, s, _, t);
    (!_.length || b) && this.unexpected(this.lastTokStart), G && this.unexpected(G), this.checkExpressionErrors(O, true), this.yieldPos = L || this.yieldPos, this.awaitPos = B || this.awaitPos, _.length > 1 ? (l = this.startNodeAt(m, w), l.expressions = _, this.finishNodeAt(l, "SequenceExpression", F, R)) : l = _[0];
...
Pe.readInt = function(e, t, i) {
  for (var s = this.options.ecmaVersion >= 12 && t === void 0, l = i && this.input.charCodeAt(this.pos) === 48, p = this.pos, m = 0, w = 0, _ = 0, o = t ?? 1 / 0; _ < o; ++_, ++this.pos) {
    var b = this.input.charCodeAt(this.pos), O = void 0;
    if (s && b === 95) {
    ...
    if (b >= 97 ? O = b - 97 + 10 : b >= 65 ? O = b - 65 + 10 : b >= 48 && b <= 57 ? O = b - 48 : O = 1 / 0, O >= e) break;
    w = b, m = m * e + O;
  }
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  function l(b, O) {
    if (b) {
      if (typeof b == "string") return p(b, O);
      var L = {}.toString.call(b).slice(8, -1);
      return L === "Object" && b.constructor && (L = b.constructor.name), L === "Map" || L === "Set" ? Array.from(b) : L === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(L) ? p(b, O) : void 0;
    }
  }
  function p(b, O) {
    (O == null || O > b.length) && (O = b.length);
    for (var L = 0, B = Array(O); L < O; L++) B[L] = b[L];
    return B;
  }
  function m(b, O) {
    var L = b == null ? null : typeof Symbol < "u" && b[Symbol.iterator] || b["@@iterator"];
    if (L != null) {
      var B, G, F, R, v = [], h = true, g = false;
      try {
        if (F = (L = L.call(b)).next, O === 0) {
          if (Object(L) !== L) return;
          h = false;
        } else for (; !(h = (B = F.call(L)).done) && (v.push(B.value), v.length !== O); h = true) ;
      } catch (S) {
        g = true, G = S;
      } finally {
        try {
          if (!h && L.return != null && (R = L.return(), Object(R) !== R)) return;
        } finally {
          if (g) throw G;
        }
      }
  ...
  var _ = [["aria-activedescendant", { type: "id" }], ["aria-atomic", { type: "boolean" }], ["aria-autocomplete", { type: "token", values: ["inline", "list", "both", "none"] }], ["aria-braillelabel", { type: "string" }], ["aria-brailleroledescription", { type: "string" }], ["aria-busy", { type: "boolean" }], ["aria-checked", { type: "tristate" }], ["aria-colcount", { type: "integer" }], ["aria-colindex", { type: "integer" }], ["aria-colspan", { type: "integer" }], ["aria-controls", { type: "idlist" }], ["aria-current", { type: "token", values: ["page", "step", "location", "date", "time", true, false] }], ["aria-describedby", { type: "idlist" }], ["aria-description", { type: "string" }], ["aria-details", { type: "id" }], ["aria-disabled", { type: "boolean" }], ["aria-dropeffect", { type: "tokenlist", values: ["copy", "execute", "link", "move", "none", "popup"] }], ["aria-errormessage", { type: "id" }], ["aria-expanded", { type: "boolean", allowundefined: true }], ["aria-flowto", { type: "idlist" }], ["aria-grabbed", { type: "boolean", allowundefined: true }], ["aria-haspopup", { type: "token", values: [false, true, "menu", "listbox", "tree", "grid", "dialog"] }], ["aria-hidden", { type: "boolean", allowundefined: true }], ["aria-invalid", { type: "token", values: ["grammar", false, "spelling", true] }], ["aria-keyshortcuts", { type: "string" }], ["aria-label", { type: "string" }], ["aria-labelledby", { type: "idlist" }], ["aria-level", { type: "integer" }], ["aria-live", { type: "token", values: ["assertive", "off", "polite"] }], ["aria-modal", { type: "boolean" }], ["aria-multiline", { type: "boolean" }], ["aria-multiselectable", { type: "boolean" }], ["aria-orientation", { type: "token", values: ["vertical", "undefined", "horizontal"] }], ["aria-owns", { type: "idlist" }], ["aria-placeholder", { type: "string" }], ["aria-posinset", { type: "integer" }], ["aria-pressed", { type: "tristate" }], ["aria-readonly", { type: "boolean" }], ["aria-relevant", { type: "tokenlist", values: ["additions", "all", "removals", "text"] }], ["aria-required", { type: "boolean" }], ["aria-roledescription", { type: "string" }], ["aria-rowcount", { type: "integer" }], ["aria-rowindex", { type: "integer" }], ["aria-rowspan", { type: "integer" }], ["aria-selected", { type: "boolean", allowundefined: true }], ["aria-setsize", { type: "integer" }], ["aria-sort", { type: "token", values: ["ascending", "descending", "none", "other"] }], ["aria-valuemax", { type: "number" }], ["aria-valuemin", { type: "number" }], ["aria-valuenow", { type: "number" }], ["aria-valuetext", { type: "string" }]], o = { entries: function() {
    ...
    for (var L = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, B = 0, G = _; B < G.length; B++) {
      var F = i(G[B], 2), R = F[0], v = F[1];
      O.call(L, v, R, _);
    }
  }, get: function(O) {
    var L = _.filter(function(B) {
      return B[0] === O;
    })[0];
    return L && L[1];
  }, has: function(O) {
...
function v0() {
  ...
  var e = L(i0()), t = L(s0()), i = L(n0()), s = L(o0()), l = L(l0()), p = L(u0()), m = L(c0()), w = L(d0()), _ = L(p0()), o = L(f0()), b = L(h0()), O = L(m0());
  function L(G) {
    return G && G.__esModule ? G : { default: G };
  }
  var B = [["command", e.default], ["composite", t.default], ["input", i.default], ["landmark", s.default], ["range", l.default], ["roletype", p.default], ["section", m.default], ["sectionhead", w.default], ["select", _.default], ["structure", o.default], ["widget", b.default], ["window", O.default]];
...
function Ly() {
  ...
  var e = q(zb()), t = q(Xb()), i = q(Kb()), s = q(Jb()), l = q(Qb()), p = q(Yb()), m = q(Zb()), w = q(ey()), _ = q(ty()), o = q(ry()), b = q(ay()), O = q(iy()), L = q(sy()), B = q(ny()), G = q(oy()), F = q(ly()), R = q(uy()), v = q(cy()), h = q(dy()), g = q(py()), S = q(fy()), C = q(hy()), x = q(my()), E = q(vy()), D = q(by()), z = q(yy()), Z = q(gy()), A = q(Ry()), N = q(xy()), I = q(_y()), M = q(Cy()), V = q(Py()), c = q(qy()), r = q(Ty()), a = q(Sy()), n = q(wy()), u = q(Ay()), f = q(Ey()), y = q(ky()), P = q(Iy()), T = q(My());
  function q(J) {
    return J && J.__esModule ? J : { default: J };
  }
  var H = [["doc-abstract", e.default], ["doc-acknowledgments", t.default], ["doc-afterword", i.default], ["doc-appendix", s.default], ["doc-backlink", l.default], ["doc-biblioentry", p.default], ["doc-bibliography", m.default], ["doc-biblioref", w.default], ["doc-chapter", _.default], ["doc-colophon", o.default], ["doc-conclusion", b.default], ["doc-cover", O.default], ["doc-credit", L.default], ["doc-credits", B.default], ["doc-dedication", G.default], ["doc-endnote", F.default], ["doc-endnotes", R.default], ["doc-epigraph", v.default], ["doc-epilogue", h.default], ["doc-errata", g.default], ["doc-example", S.default], ["doc-footnote", C.default], ["doc-foreword", x.default], ["doc-glossary", E.default], ["doc-glossref", D.default], ["doc-index", z.default], ["doc-introduction", Z.default], ["doc-noteref", A.default], ["doc-notice", N.default], ["doc-pagebreak", I.default], ["doc-pagefooter", M.default], ["doc-pageheader", V.default], ["doc-pagelist", c.default], ["doc-part", r.default], ["doc-preface", a.default], ["doc-prologue", n.default], ["doc-pullquote", u.default], ["doc-qna", f.default], ["doc-subtitle", y.default], ["doc-tip", P.default], ["doc-toc", T.default]];
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  for (var o = [], b = t.default.keys(), O = 0; O < b.length; O++) {
    var L = b[O], B = t.default.get(L);
    if (B) for (var G = [].concat(B.baseConcepts, B.relatedConcepts), F = function() {
      ...
      if (x.module === "HTML") {
        ...
        if (E) {
          ...
          D ? z = D[1] : z = [];
          for (var Z = true, A = 0; A < z.length; A++) if (z[A] === L) {
            Z = false;
            break;
          }
          Z && z.push(L), D || o.push([E, z]);
        }
      }
    }, R = 0; R < G.length; R++) F();
  }
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var b = [], O = w(t.default.entries()), L;
  try {
    var B = function() {
      var v = s(L.value, 2), h = v[0], g = v[1], S = g.relatedConcepts;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var b = [], O = w(e.default.entries()), L;
  try {
    var B = function() {
      var h = s(L.value, 2), g = h[0], S = h[1], C = S.relatedConcepts;
  ...
  return fh || (fh = 1, function(e, t) {
    (function(i, s) {
      ...
      class B {
        ...
        write(N) {
          const { buffer: I } = this;
          I[this.pos++] = N, this.pos === O && (this.out += L.decode(I), this.pos = 0);
        }
        flush() {
          const { buffer: N, out: I, pos: M } = this;
          return M > 0 ? I + L.decode(N.subarray(0, M)) : I;
        }
      }
      class G {
        constructor(N) {
...
function bm() {
  return mh || (mh = 1, function(e, t) {
    (function(i, s) {
      ...
      const w = 0, _ = 1, o = 2, b = 3, O = 4, L = 1, B = 2;
      function G(j, X) {
        const K = F(j, 0);
      ...
      function V(j, X, K, ee, ce, se, Re, ke, ge, Ae, ze) {
        ...
        for (let Xe = 0; Xe < Ie.length; Xe++) {
          ...
          for (let Y = 0; Y < Ht.length; Y++) {
            ...
            Ye.push(yt.length === 4 ? [gt, Eo, ko, Io] : [gt, Eo, ko, Io, te + yt[O]]);
          }
        }
      }
      function c(j, X) {
      ...
      function J(j, X) {
        ...
        return Ne(ze[ge[_]], ge[o] + 1, ge[b], ge.length === 5 ? Ae[ge[O]] : null);
      }
      function re(j, X) {
  ...
  return vh || (vh = 1, function(e, t) {
    (function(i, s) {
      ...
      function m(o, b) {
        ...
        const { array: L, _indexes: B } = o, G = L.push(b);
        return B[b] = G - 1;
      }
      function w(o) {
        const { array: b, _indexes: O } = o;
...
function Rx() {
  return bh || (bh = 1, function(e, t) {
    (function(i, s) {
      ...
      function x(r) {
        const a = new p.TraceMap(r), n = new L({ file: a.file, sourceRoot: a.sourceRoot });
      ...
      i.GenMapping = L, i.addMapping = F, i.addSegment = G, i.allMappings = E, i.fromMap = x, i.maybeAddMapping = v, i.maybeAddSegment = R, i.setIgnore = g, i.setSourceContent = h, i.toDecodedMap = S, i.toEncodedMap = C, Object.defineProperty(i, "__esModule", { value: true });
    });
  ...
  return yh || (yh = 1, function(e, t) {
    (function(i, s) {
      ...
      function b(v) {
        ...
        for (let E = 0; E < x.length; E++) {
          ...
          for (let z = 0; z < D.length; z++) {
            ...
            if (Z.length !== 1) {
              const n = g[Z[1]];
              if (N = O(n, Z[2], Z[3], Z.length === 5 ? C[Z[4]] : ""), N == null) continue;
            }
      ...
      function O(v, h, g, S) {
        ...
        return C == null ? null : C.length === 1 ? l : O(v.sources[C[1]], C[2], C[3], C.length === 5 ? v.map.names[C[4]] : S);
      }
      function L(v) {
        return Array.isArray(v) ? v : [v];
      }
      function B(v, h) {
        const g = L(v).map((x) => new i.TraceMap(x, "")), S = g.pop();
...
function Ox(e, t) {
  ...
  let s = Yt(), l = Dt(), p = ie(false), m = ie(""), w = ie(false), _ = ie(void 0), o = ie(false), b = ie(""), O = ie(""), L = _t(() => {
    var _a3;
    return k(b).length > (((_a3 = k(_)) == null ? void 0 : _a3.length_min) || 8) && k(b) === k(O);
  ...
  function v() {
    if ($(m, ""), !k(_)) return;
    let D = vv(k(_));
    $(b, W(D)), $(O, W(D)), requestAnimationFrame(() => {
      var _a3, _b2;
...
function Wx(e, t) {
  ...
  async function p() {
    ...
    L.error ? $(l, W(L.error.message)) : t.onSave();
  }
  var m = Gx(), w = Le(m), _ = ve(w, true);
  me(w);
  var o = ne(w, 2);
  wt(o, { level: -1, onclick: p, children: (L, B) => {
    Ke();
    var G = $e();
    _e(() => xe(G, i.common.delete)), ae(L, G);
  }, $$slots: { default: true } });
  var b = ne(o, 2);
  {
    var O = (L) => {
      var B = Ux(), G = ve(B, true);
      me(B), _e(() => xe(G, k(l))), ae(L, B);
    };
    Se(b, (L) => {
      k(l) && L(O);
    });
...
function D_(e, t) {
  ...
  let s = ie(void 0), l = ie(""), p = ie(W([])), m = ie(W([])), w = ie(W([])), _ = dv("uid"), o = ie(void 0), b = ie(W([])), O = ie(W([])), L = ie(false), B = ie(void 0), G = ie(W(Pv)), F = ie(false), R = W(["E-Mail", "ID"]), v = ie(W(R[0])), h = ie(""), g = W(["E-Mail", "ID", "Created", "Last Login"]);
  gl(() => {
    C("page_size=" + k(G)), x(), E();
  }), At(() => {
    var _a3;
    ...
    k(L) ? M.length < 3 ? k(F) && (C("page_size=" + k(G)), $(F, false)) : S(M) : M ? k(v) === R[0] ? $(m, W(k(p).filter((V) => {
      var _a3;
  ...
  async function C(M) {
    ...
    M && (V += `?${M}`);
    let c = await Nt(V);
    return c.error ? $(l, "Error fetching users: " + c.error.message) : c.body && (c.status === 206 ? ($(L, true), $(B, W(c.headers))) : ($(L, false), $(B, void 0)), $(p, W(c.body))), [c.status, c.headers];
  }
  async function x() {
    var _a3;
    let M = await Nt("/auth/v1/roles");
    M.body ? $(O, W(M.body.toSorted((V, c) => V.name.localeCompare(c.name)))) : $(l, W(((_a3 = M.error) == null ? void 0 : _a3.message) || "Error"));
  }
  async function E() {
    var _a3;
