import { Q as V, h as f, u as N, a3 as x, y as M, aw as m, ax as T, ay as H, L as O, at as $, O as G, R as W, d as Q, az as U, z as j, m as S, C as b, q as k, i as v, aA as R, H as A, b as J, W as K, o as X, aB as Z, Y as ee, aC as te, g as re, p as ae, aD as ne, a as oe } from "./CmQi0fbH.js";
import { b as ie } from "./DLBGyKVC.js";
function ye(e) {
...
const B = /* @__PURE__ */ new Set(), C = /* @__PURE__ */ new Set();
function ke(e) {
  if (!f) return;
...
function Se(e) {
  ...
  var n;
  if (f) {
    for (t = v, u === void 0 && (u = N(document.head)); u !== null && (u.nodeType !== 8 || u.data !== j); ) u = S(u);
    u === null ? b(false) : u = k(S(u));
  }
  f || (n = document.head.appendChild(W()));
  try {
    Q(() => e(n), U);
  } finally {
    a && (b(true), u = v, k(t));
...
function Ce(e, t) {
  R(), t.intro = t.intro ?? false;
  const a = t.target, n = f, o = v;
  try {
    for (var r = N(a); r && (r.nodeType !== 8 || r.data !== j); ) r = S(r);
    if (!r) throw A;
    b(true), k(r), J();
    const l = Y(e, { ...t, anchor: r });
    if (v === null || v.nodeType !== 8 || v.data !== K) throw X(), A;
    return b(false), l;
  } catch (l) {
    if (l === A) return t.recover === false && Z(), R(), x(a), b(false), ve(e, t);
    throw l;
  } finally {
    b(n), k(o), _e();
  }
...
function Y(e, { target: t, anchor: a, props: n = {}, events: o, context: r, intro: l = true }) {
  ...
  var p = void 0, L = te(() => {
    ...
    return re(() => {
      ...
      o && (n.$$events = o), f && ie(c, null), P = l, p = e(c, n) || {}, P = true, f && (O.nodes_end = v), r && oe();
    }), () => {
      var _a;
      for (var i of h) {
      ...
      C.delete(d), c !== a && ((_a = c.parentNode) == null ? void 0 : _a.removeChild(c));
    };
  });
  return D.set(p, L), p;
}
