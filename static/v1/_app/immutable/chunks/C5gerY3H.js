import { d as A, a as _, t as S } from "./CWf9OOFK.js";
import { p as J, a6 as M, l as P, k as H, ab as G, j as l, f as B, a as Q, c as n, r as c, s as z, t as T } from "./nlANaGLT.js";
import { s as D } from "./BmMHVVX3.js";
import { i as k } from "./DOjUa9u5.js";
import { p as V } from "./5u5qd9TD.js";
import { L as X } from "./BEQMYyDu.js";
import { L as Y, M as Z, p as $, N as x } from "./B21bTIl7.js";
import { b as U } from "./BO1A6s0c.js";
import { u as ee } from "./DwvS5LQk.js";
function me(o) {
  let t = Z(o);
  const a = { "+": "-", "/": "_", "=": "" };
...
async function re(o, t, a, e) {
  var _a;
  let b = { purpose: t }, d = await U(`/auth/v1/users/${o}/webauthn/auth/start`, b);
  ...
  const m = (h.exp - 1) * 1e3, g = (/* @__PURE__ */ new Date()).getTime() + m;
  let s;
  try {
    ...
    return { error: (/* @__PURE__ */ new Date()).getTime() >= g ? e : a };
  }
...
function pe(o, t) {
  ...
  {
    var h = (i) => {
      var m = se(), g = n(m), s = n(g), y = n(s), v = n(y), r = n(v, true);
      c(v), c(y);
      ...
      c(K), c(s), c(g), c(m), T(() => D(r, a.authorize.expectingPasskey)), _(i, m);
    };
    k(d, (i) => {
      t.purpose && i(h);
    });
