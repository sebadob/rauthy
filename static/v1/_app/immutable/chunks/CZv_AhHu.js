import { h as p, ao as Y, ap as y, N as z, aq as D, C as w, ar as K } from "./nlANaGLT.js";
import { i as F, c as J, d as Q, f as W, n as X, g as Z, j as m } from "./BmMHVVX3.js";
function U(r) {
  var i, f, s = "";
...
function E(r, i, f, s) {
  var t = $(r);
  p && (t[i] = r.getAttribute(i), i === "src" || i === "srcset" || i === "href" && r.nodeName === "LINK") || t[i] !== (t[i] = f) && (i === "loading" && (r[Y] = f), f == null ? r.removeAttribute(i) : typeof f != "string" && B(r).includes(i) ? r[i] = f : r.setAttribute(i, f));
}
