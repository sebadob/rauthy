...
#[openapi(
    paths(
        ...
        users::await_mfa_app,
        users::listen_mfa_app,
        users::add_new_mfa_app,
        users::mfa_register_ws,
    ...
    components(
        schemas(
            ...
            response::MfaAckResponse,
            response::MfaAppRegResponse,
            response::MfaAppInitResponse,
            response::MfaLoginRequest,
            response::MfaLoginRequestState,
            response::MfaLoginRequestAwait,
