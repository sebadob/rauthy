...
pub enum HtmlTemplate {
    ...
    ClientName(String),
    ClientUrl(String),
    ClientFaviconUpdated(Option<i64>),
...
impl HtmlTemplate {
    ...
    pub fn id(&self) -> &'static str {
        match self {
            ...
            Self::ClientFaviconUpdated(_) => "tpl_client_favicon_updated",
            ...
            Self::IsOtpEnabled(_) => "tpl_is_otp_enabled",
    ...
    pub fn inner(&self) -> String {
        match self {
            ...
            Self::ClientFaviconUpdated(i) => i.map(|i| i.to_string()).unwrap_or_default(),
            ...
            Self::IsOtpEnabled(i) => i.to_string(),
