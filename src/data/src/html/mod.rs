...
use crate::html::templates::{
    ...
    AdminConfigPolicyHtml, AdminEventsHtml, AdminGroupsHtml, AdminHtml, AdminKVHtml, AdminPAMHtml,
...
impl HtmlCached {
    ...
    pub async fn handle(
        ...
        let body = match self {
            ...
            Self::AdminKV => AdminKVHtml::build(&lang, theme_ts),
