...
#[openapi(
    paths(
        ...
        clients::get_client_favicon,
        clients::get_client_logo,
        clients::put_client_favicon,
        clients::put_client_logo,
        clients::delete_client_favicon,
        ...
        users::post_webauthn_auth_start_login,
        users::post_webauthn_auth_finish,
        users::post_webauthn_auth_finish_login,
    ...
    components(
        schemas(
            ...
            entity::roles::Role,
            entity::scopes::Scope,
            entity::webauthn::auth_data::WebauthnAdditionalData,
            entity::webauthn::auth_req::WebauthnLoginReq,
            entity::webauthn::auth_req::WebauthnServiceReq,
