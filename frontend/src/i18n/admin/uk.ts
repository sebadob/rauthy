...
export let I18nAdminUk: I18nAdmin = {
    ...
    users: {
        ...
        groupAdmin: {
            ...
            notManagedDesc: `Цей користувач не входить до жодної з керованих вами груп, тому його дані приховано. Додайте користувача до однієї або кількох ваших груп, щоб керувати ним. Членство поза вашими групами зберігається.`,
