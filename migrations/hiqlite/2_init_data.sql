...
values ('init_client', 'Init Client', 1, 1,
        ...
        'openid,email,profile,groups', 'openid', 'S256,plain', 0, null, null),
       ('rauthy', 'Rauthy', 1, 0, null, null,
        ...
        'authorization_code,password', 'EdDSA', 'EdDSA', 60, 1800, 'openid,email,profile,groups', 'openid', 'S256', 0,
        null, null);

insert into config (id, data)
values ('password_policy', x'0E000000800000000101000000010100000001010000000001B40000000103000000');
...
values ('2PYV3STNz3MN7VnPjJVcPQap', 'test_admin@localhost.de', 'Admin', 'Test', null, 'rauthy_admin', 'admin', 1, 1,
        null, 1680971459, null, null, null, 'en', null, null, null, null),
       ('m4PJ3TnyP32LA8hzY23deme3', 'init_admin@localhost.de', 'Admin', 'Init',
        ...
        'rauthy_admin', 'admin', 1, 1, null, 1680971459, null, null, null, 'en', null, null, null, null),
       ('za9UxpH7XVxqrtpEbThoqvn2', 'admin@localhost.de', 'Rauthy', 'Admin',
        ...
        'rauthy_admin,admin', 'admin', 1, 1, null, 1680971457, 1680975378, null, null, 'en', null, null, null, null);